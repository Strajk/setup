...
DB = openDatabase("SearchO", "", "SearchO items", 5242880, function (a) {
  a.transaction(function (b) {
    b.executeSql("CREATE TABLE items (id INTEGER PRIMARY KEY,name TEXT NOT NULL,searchurl TEXT NOT NULL,icondataurl TEXT,suggestionuri TEXT,enable INTEGER,sort INTEGER,category TEXT);", [], function () {
...
function AddCustomizeSearch(a, b, c, d) {
  DB.transaction(function (e) {
    e.executeSql("INSERT INTO items (name, searchurl, icondataurl, suggestionuri, enable, sort, category) VALUES (?, ?, ?, ?, ?, ?, ?);", [a, b, c, "", 1, 0, "customize"], function (f, g) {
      d(f, g)
    })
  })
}
