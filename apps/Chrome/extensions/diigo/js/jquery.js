(function (I, z) {
  ...
  function Da(a, b, d) {
    ...
    if (i && (d === "queue" || !c._data(a, f)) && (d === "mark" || !c._data(a, g))) setTimeout(function () {
  ...
  function Ea(a, b, d) {
    ...
    if (c.isFunction(b)) return c.grep(a, function (f, g) {
      ...
      if (tb.test(b)) return c.filter(b, e, !d); else b = c.filter(b, e)
    }
  ...
  function Ha(a, b) {
    if (!(b.nodeType !== 1 || !c.hasData(a))) {
      ...
      if (i) {
        ...
        for (d in i) {
          e = 0;
          for (f = i[d].length; e < f; e++) c.event.add(b, d + (i[d][e].namespace ?
            "." : "") + i[d][e].namespace, i[d][e], i[d][e].data)
        }
      }
  ...
  function Ia(a, b) {
    ...
    if (b.nodeType === 1) {
      ...
      } else if (d === "option") b.selected = a.defaultSelected; else if (d === "input" || d === "textarea") b.defaultValue =
        a.defaultValue;
  ...
  function Ka(a) {
    ...
    if (b === "input") Ja(a); else b !== "script" && typeof a.getElementsByTagName !== "undefined" && c.grep(a.getElementsByTagName("input"), Ja)
  }
  ...
  function La(a, b, d) {
    var e = b === "width" ? a.offsetWidth : a.offsetHeight, f = b === "width" ? wb : xb, g = 0, i = f.length;
    if (e > 0) {
      if (d !== "border") for (; g < i; g++) {
        d || (e -= parseFloat(c.css(a, "padding" + f[g])) || 0);
        if (d === "margin") e += parseFloat(c.css(a, d + f[g])) || 0; else e -= parseFloat(c.css(a, "border" + f[g] + "Width")) || 0
      }
      return e + "px"
    }
    e = aa(a, b, b);
  ...
  function Ma(a) {
    return function (b, d) {
      ...
      if (c.isFunction(d)) for (var e = b.toLowerCase().split(Na), f = 0, g = e.length, i, l; f < g; f++) {
        i = e[f];
  ...
  function ja(a, b, d, e, f, g) {
    ...
    for (var i = 0, l = f ? f.length : 0, m = a === ra, p; i < l && (m || !p); i++) {
      p = f[i](b, d, e);
      if (typeof p === "string") if (!m || g[p]) p = z; else {
  ...
  function sa(a, b, d, e) {
    ...
    }); else if (!d && b != null && typeof b ===
      "object") for (var f in b) sa(a + "[" + f + "]", b[f], d, e); else e(a, b)
  }
  ...
  function Sa(a) {
    if (!ta[a]) {
      var b = B.body, d = c("<" + a + ">").appendTo(b), e = d.css("display");
      d.remove();
      if (e === "none" || e === "") {
        if (!R) {
        ...
        if (!ca || !R.createElement) {
          ca =
            (R.contentWindow || R.contentDocument).document;
  ...
  var B = I.document, Ab = I.navigator, Bb = I.location, c = function () {
    function a() {
      if (!b.isReady) {
        try {
    ...
    var b =
        ...
        }, d = I.jQuery, e = I.$, f, g = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, i = /\S/, l = /^\s+/, m = /\s+$/, p = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, v = /^[\],:{}\s]*$/, s = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, A = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, w = /(?:^|:|,)(?:\s*\[)+/g, F = /(webkit)[ \/]([\w.]+)/, J = /(opera)(?:.*version)?[ \/]([\w.]+)/, M = /(msie) ([\w.]+)/, K = /(mozilla)(?:.*? rv:([\w.]+))?/, T = /-([a-z]|[0-9])/ig, O = /^-ms-/, G = function (k, t) {
        return (t + "").toUpperCase()
      },
      Q = Ab.userAgent, h, j, n = Object.prototype.toString, o = Object.prototype.hasOwnProperty, q = Array.prototype.push, r = Array.prototype.slice, C = String.prototype.trim, x = Array.prototype.indexOf, H = {};
    b.fn = b.prototype = {
      constructor: b, init: function (k, t, y) {
        var u;
        if (!k) return this;
        if (k.nodeType) {
        ...
        if (typeof k === "string") if ((u = k.charAt(0) === "<" && k.charAt(k.length - 1) === ">" && k.length >=
        3 ? [null, k, null] : g.exec(k)) && (u[1] || !t)) if (u[1]) {
          y = (t = t instanceof b ? t[0] : t) ? t.ownerDocument || t : B;
          if (k = p.exec(k)) if (b.isPlainObject(t)) {
            k = [B.createElement(k[1])];
            b.fn.attr.call(k, t, true)
          } else k = [y.createElement(k[1])]; else {
          ...
          this.selector = k;
          return this
        } else return !t || t.jquery ?
          (t || y).find(k) : this.constructor(t).find(k); else if (b.isFunction(k)) return y.ready(k);
        if (k.selector !== z) {
        ...
        if (t === "find") u.selector = this.selector + (this.selector ? " " : "") + y; else if (t) u.selector = this.selector + "." + t + "(" + y + ")";
        return u
      }, each: function (k, t) {
    ...
    b.extend = b.fn.extend = function () {
      var k, t, y, u, E, D = arguments[0] || {}, L = 1, N = arguments.length, W = false;
      if (typeof D === "boolean") {
        W = D;
        D = arguments[1] || {};
        L = 2
      ...
      for (; L < N; L++) if ((k = arguments[L]) != null) for (t in k) {
        y = D[t];
        u = k[t];
        if (D !== u) if (W && u && (b.isPlainObject(u) || (E = b.isArray(u)))) {
          if (E) {
            E =
              false;
            y = y && b.isArray(y) ? y : []
    ...
    b.extend({
      ...
      bindReady: function () {
        ...
        if (!t || !t.documentElement ||
          t.getElementsByTagName("parsererror").length) b.error("Invalid XML: " + k);
        return t
      }, noop: function () {
      }, globalEval: function (k) {
        if (k && i.test(k)) (I.execScript || function (t) {
          I.eval.call(I, t)
        })(k)
        ...
        var u, E = 0, D = k.length, L = D === z || b.isFunction(k);
        if (y) if (L) for (u in k) {
          if (t.apply(k[u], y) === false) break
        } else for (; E < D;) {
          if (t.apply(k[E++], y) === false) break
        } else if (L) for (u in k) {
          if (t.call(k[u],
            u, k[u]) === false) break
        ...
        if (t) {
          ...
          u = t.length;
          for (y = y ? y < 0 ? Math.max(0, u + y) : y : 0; y < u; y++) if (y in t &&
            t[y] === k) return y
        }
        return -1
      }, merge: function (k, t) {
        var y = k.length, u = 0;
        if (typeof t.length === "number") for (var E = t.length; u < E; u++) k[y++] = t[u]; else for (; t[u] !== z;) k[y++] = t[u++];
        k.length = y;
        return k
      }, grep: function (k, t, y) {
        var u = [], E;
        ...
        var u, E, D = [], L = 0, N = k.length;
        if (k instanceof b || N !== z && typeof N === "number" && (N > 0 && k[0] && k[N - 1] || N === 0 || b.isArray(k))) for (; L < N; L++) {
          u = t(k[L], L, y);
        ...
        if (y !== z) {
          ...
          for (N = 0; N < L; N++) E(k[N], t, u ? y.call(k[N], N, E(k[N], t)) :
            y, D);
          return k
        }
        return L ? E(k[0], t) : z
    ...
    f = b(B);
    if (B.addEventListener) j = function () {
      B.removeEventListener("DOMContentLoaded", j, false);
      b.ready()
    }; else if (B.attachEvent) j = function () {
      if (B.readyState === "complete") {
        B.detachEvent("onreadystatechange",
          j);
        b.ready()
      }
    };
  ...
  c.Callbacks = function (a) {
    a = a ? Ba[a] || qb(a) : {};
    var b = [], d = [], e, f, g, i, l, m = function (s) {
      var A, w, F, J;
      A = 0;
      for (w = s.length; A < w; A++) {
        F = s[A];
        J = c.type(F);
        if (J === "array") m(F); else if (J === "function") if (!a.unique || !v.has(F)) b.push(F)
      }
    }, p = function (s, A) {
      A = A || [];
      e = !a.memory || [s, A];
      ...
      l = g || 0;
      g = 0;
      for (i = b.length; b && l < i; l++) if (b[l].apply(s, A) === false && a.stopOnFalse) {
        e = true;
        break
      }
      f = false;
      if (b) if (a.once) if (e === true) v.disable(); else b = []; else if (d && d.length) {
        e = d.shift();
        v.fireWith(e[0],
          e[1])
      }
      ...
      add: function () {
        if (b) {
          var s = b.length;
          m(arguments);
          if (f) i = b.length; else if (e && e !== true) {
            g = s;
            p(e[0], e[1])
          }
        }
        ...
        if (b) for (var s = arguments, A = 0, w = s.length; A < w; A++) for (var F = 0; F < b.length; F++) if (s[A] === b[F]) {
          if (f) if (F <= i) {
            i--;
            F <= l && l--
          }
      ...
      lock: function () {
        ...
        if (d) if (f) a.once || d.push([s, A]); else a.once && e || p(s, A);
        return this
      }, fire: function () {
  ...
  c.extend({
    Deferred: function (a) {
      var b = c.Callbacks("once memory"), d = c.Callbacks("once memory"), e = c.Callbacks("memory"), f = "pending", g = {resolve: b, reject: d, notify: e}, i = {
        done: b.add, fail: d.add, progress: e.add, state: function () {
          return f
        },
        isResolved: b.fired, isRejected: d.fired, then: function (p, v, s) {
          ...
          return c.Deferred(function (A) {
            c.each({done: [p, "resolve"], fail: [v, "reject"], progress: [s, "notify"]}, function (w, F) {
              var J = F[0], M = F[1], K;
              c.isFunction(J) ? l[w](function () {
                  (K = J.apply(this, arguments)) && c.isFunction(K.promise) ? K.promise().then(A.resolve, A.reject, A.notify) : A[M + "With"](this === l ? A : this, [K])
                }) :
                l[w](A[M])
            })
          }).promise()
        }, promise: function (p) {
          if (p == null) p = i; else for (var v in i) p[v] = i[v];
          return p
        }
      }, l = i.promise({}), m;
      for (m in g) {
      ...
      var e = va.call(arguments, 0), f = 0, g = e.length, i = Array(g), l = g, m = g <= 1 && a && c.isFunction(a.promise) ? a : c.Deferred(), p = m.promise();
      if (g > 1) {
        for (; f < g; f++) if (e[f] && e[f].promise && c.isFunction(e[f].promise)) e[f].promise().then(b(f), m.reject, d(f)); else --l;
        l || m.resolveWith(m, e)
  ...
  c.support = function () {
    var a, b, d, e, f, g, i, l, m = B.createElement("div");
    ...
    a = {
      leadingWhitespace: m.firstChild.nodeType === 3, tbody: !m.getElementsByTagName("tbody").length, htmlSerialize: !!m.getElementsByTagName("link").length, style: /top/.test(d.getAttribute("style")), hrefNormalized: d.getAttribute("href") === "/a", opacity: /^0.55/.test(d.style.opacity), cssFloat: !!d.style.cssFloat,
    ...
    if (I.getComputedStyle) {
      ...
      m.style.width = "2px";
      m.appendChild(b);
      a.reliableMarginRight = (parseInt((I.getComputedStyle(b, null) || {marginRight: 0}).marginRight, 10) || 0) === 0
    }
    if (m.attachEvent) for (i in {submit: 1, change: 1, focusin: 1}) {
      b = "on" + i;
      l = b in m;
      if (!l) {
    ...
    d = e = f = b = m = b = null;
    c(function () {
      var v, s, A, w, F = B.getElementsByTagName("body")[0];
      if (F) {
        ...
        c.boxModel = a.boxModel = m.offsetWidth ===
          2;
        ...
        s = m.firstChild;
        A = s.firstChild;
        w = {doesNotAddBorder: A.offsetTop !== 5, doesAddBorderForTableAndCells: s.nextSibling.firstChild.firstChild.offsetTop === 5};
  ...
  var sb = /^(?:\{.*\}|\[.*\])$/,
    rb = /([A-Z])/g;
  c.extend({
    cache: {}, uuid: 0, expando: "jQuery" + (c.fn.jquery + Math.random()).replace(/\D/g, ""), noData: {embed: true, object: "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", applet: true}, hasData: function (a) {
      ...
      if (c.acceptData(a)) {
        var f;
        f = c.expando;
        var g = typeof b === "string", i = a.nodeType, l = i ? c.cache : a, m = i ? a[f] : a[f] && f, p = b === "events";
        if (!((!m || !l[m] || !p && !e && !l[m].data) && g && d === z)) {
          if (!m) if (i) a[f] = m = ++c.uuid; else m =
            f;
          if (!l[m]) {
            l[m] = {};
            if (!i) l[m].toJSON = c.noop
          }
          if (typeof b === "object" || typeof b === "function") if (e) l[m] = c.extend(l[m], b); else l[m].data = c.extend(l[m].data, b);
          f = a = l[m];
          if (!e) {
            if (!a.data) a.data = {};
            a = a.data
      ...
      if (c.acceptData(a)) {
        var e, f, g, i = c.expando, l = a.nodeType, m = l ? c.cache : a, p = l ? a[i] : i;
        if (m[p]) {
          if (b) if (e = d ? m[p] : m[p].data) {
            if (!c.isArray(b)) if (b in e) b = [b]; else {
              b =
                c.camelCase(b);
              b = b in e ? [b] : b.split(" ")
            }
          ...
          if (c.support.deleteExpando || !m.setInterval) delete m[p]; else m[p] = null;
          if (l) if (c.support.deleteExpando) delete a[i]; else if (a.removeAttribute) a.removeAttribute(i); else a[i] = null
        }
      }
      ...
      if (a.nodeName) {
        ...
        if (b) return !(b === true || a.getAttribute("classid") !==
          b)
      }
      return true
    }
    ...
    _mark: function (a, b) {
      ...
      if (b) {
        d =
          d || "fx";
        var e = d + "mark";
        if (a = a ? 0 : (c._data(b, e) || 1) - 1) c._data(b, e, a); else {
      ...
      if (a) {
        b = (b || "fx") + "queue";
        e = c._data(a, b);
        if (d) if (!e || c.isArray(d)) e = c._data(a, b, c.makeArray(d)); else e.push(d);
        return e || []
      }
    }, dequeue: function (a, b) {
      b = b || "fx";
      var d = c.queue(a, b), e = d.shift(), f = {};
  ...
  c.fn.extend({
    queue: function (a, b) {
      ...
      a = a || "fx";
      for (var e = c.Deferred(), f = this, g = f.length, i = 1, l = a + "defer", m = a + "queue", p = a + "mark", v; g--;) if (v = c.data(f[g], l, z, true) || (c.data(f[g], m, z, true) || c.data(f[g], p, z, true)) && c.data(f[g], l, c.Callbacks("once memory"), true)) {
        i++;
        v.add(d)
      }
      d();
  ...
  var Ta = /[\n\t\r]/g, la = /\s+/, Cb = /\r/g, Db = /^(?:button|input)$/i, Eb = /^(?:button|input|object|select|textarea)$/i, Fb = /^a(?:rea)?$/i, Ua = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
    Va = c.support.getSetAttribute, S, Wa, Xa;
  c.fn.extend({
    attr: function (a, b) {
      ...
      return this.each(function () {
        if (d === "string") for (var f, g = 0, i = c(this), l = b, m = a.split(la); f = m[g++];) {
          l = e ? l : !i.hasClass(f);
      ...
      a = " " + a + " ";
      for (var b = 0, d = this.length; b < d; b++) if (this[b].nodeType === 1 && (" " + this[b].className + " ").replace(Ta, " ").indexOf(a) > -1) return true;
      return false
    }, val: function (a) {
      var b, d, e, f = this[0];
      if (arguments.length) {
  ...
  c.extend({
    valHooks: {
      option: {
        ...
        get: function (a) {
          var b, d, e = a.selectedIndex, f = [], g = a.options, i = a.type === "select-one";
          if (e < 0) return null;
          a = i ? e : 0;
      ...
      if (!(!a || i === 3 || i === 8 || i === 2)) {
        ...
        if (d !== z) if (d === null) c.removeAttr(a, b); else if (g && "set" in g && e && (f = g.set(a, d, b)) !==
          z) return f; else {
          a.setAttribute(b, "" + d);
          return d
        } else if (g && "get" in g && e && (f = g.get(a, b)) !== null) return f; else {
          f = a.getAttribute(b);
          return f === null ? z : f
        }
      }
      ...
      type: {
        set: function (a, b) {
          if (Db.test(a.nodeName) && a.parentNode) c.error("type property can't be changed"); else if (!c.support.radioValue &&
            b === "radio" && c.nodeName(a, "input")) {
            var d = a.value;
  ...
  var wa = /^(?:textarea|input|select)$/i, Ya = /^([^\.]*)?(?:\.(.+))?$/, Gb = /\bhover(\.\S+)?\b/, Hb = /^key/, Ib = /^(?:mouse|contextmenu)|click/, Za = /^(?:focusinfocus|focusoutblur)$/, Jb = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, Kb = function (a) {
    if (a = Jb.exec(a)) {
      a[1] = (a[1] || "").toLowerCase();
    ...
    return c.event.special.hover ? a : a.replace(Gb,
    ...
    add: function (a, b, d, e, f) {
      ...
      if (!(a.nodeType === 3 || a.nodeType === 8 || !b || !d || !(g = c._data(a)))) {
        ...
        for (g = 0; g < b.length; g++) {
          ...
          w = c.event.special[p] || {};
          m = c.extend({type: p, origType: m[1], data: e, handler: d, guid: d.guid, selector: f, quick: Kb(f), namespace: v.join(".")}, s);
          A = l[p];
          if (!A) {
            A = l[p] = [];
            A.delegateCount = 0;
            if (!w.setup || w.setup.call(a, e, v, i) === false) if (a.addEventListener) a.addEventListener(p, i, false); else a.attachEvent && a.attachEvent("on" + p, i)
          }
          if (w.add) {
            w.add.call(a, m);
      ...
      var g = c.hasData(a) && c._data(a), i, l, m, p, v, s, A, w, F, J;
      if (g && (A = g.events)) {
        b = c.trim($a(b || "")).split(" ");
        for (i = 0; i < b.length; i++) {
          ...
          if (m) {
            ...
            for (s = 0; s < F.length; s++) {
              J = F[s];
              if ((f || p === J.origType) && (!d || d.guid === J.guid) && (!l || l.test(J.namespace)) && (!e || e === J.selector ||
                e === "**" && J.selector)) {
                F.splice(s--, 1);
            ...
            if (d) {
              ...
              if (!(m.trigger && m.trigger.apply(d, b) === false)) {
                ...
                for (l = 0; l < v.length && !a.isPropagationStopped(); l++) {
                  ...
                  (p = i && g[i]) && c.acceptData(g) &&
                  p.apply(g, b) === false && a.preventDefault()
                }
                a.type = f;
                if (!e && !a.isDefaultPrevented()) if ((!m._default || m._default.apply(d.ownerDocument, b) === false) && !(f === "click" && c.nodeName(d, "a")) && c.acceptData(d)) if (i && d[f] && (f !== "focus" && f !== "blur" || a.target.offsetWidth !== 0) && !c.isWindow(d)) {
                  if (l = d[i]) d[i] = null;
                  c.event.triggered = f;
                  d[f]();
                  c.event.triggered = z;
      ...
      a = c.event.fix(a ||
        I.event);
      var b = (c._data(this, "events") || {})[a.type] || [], d = b.delegateCount, e = [].slice.call(arguments, 0), f = !a.exclusive && !a.namespace, g = [], i, l, m, p, v, s, A;
      e[0] = a;
          ...
          for (i = 0; i < d; i++) {
            ...
            if (v[A] === z) {
              ...
              if (p.quick) {
                J = p.quick;
                var M = l.attributes || {};
                J = (!J[1] || l.nodeName.toLowerCase() === J[1]) && (!J[2] ||
                  (M.id || {}).value === J[2]) && (!J[3] || J[3].test((M["class"] || {}).value))
              } else J = m.is(A);
              w[F] = J
            }
            v[A] && s.push(p)
          }
          s.length && g.push({elem: l, matches: s})
        }
      }
      ...
      var b,
        d, e = a, f = c.event.fixHooks[a.type] || {}, g = f.props ? this.props.concat(f.props) : this.props;
      a = c.Event(e);
      for (b = g.length; b;) {
        d = g[--b];
        a[d] = e[d]
      ...
      ready: {setup: c.bindReady}, load: {noBubble: true}, focus: {delegateType: "focusin"}, blur: {delegateType: "focusout"}, beforeunload: {
  ...
  c.removeEvent = B.removeEventListener ? function (a, b, d) {
  ...
  c.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (a, b) {
    c.event.special[a] = {
      delegateType: b, bindType: b, handle: function (d) {
        var e = d.relatedTarget, f = d.handleObj, g;
  ...
  c.fn.extend({
    on: function (a, b, d, e, f) {
      ...
      if (e === false) e = $; else if (!e) return this;
      if (f === 1) {
        g = e;
        e = function (l) {
          c().off(l);
  ...
  (function () {
    ...
    var s = function (h, j, n, o) {
      ...
      var r, C, x, H, k, t = true, y = s.isXML(j), u = [], E = h;
      do {
        d.exec("");
        if (r = d.exec(E)) {
          E = r[3];
      ...
      if (u.length > 1 && F.exec(h)) if (u.length === 2 && w.relative[u[0]]) C = Q(u[0] + u[1], j, o); else for (C = w.relative[u[0]] ? [j] : s(u.shift(), j); u.length;) {
        h = u.shift();
        ...
        if (j) {
          r = o ? {expr: u.pop(), set: K(o)} : s.find(u.pop(), u.length === 1 && (u[0] === "~" || u[0] === "+") && j.parentNode ? j.parentNode : j, y);
          C = r.expr ? s.filter(r.expr, r.set) : r.set;
          if (u.length > 0) x = K(C); else t = false;
          for (; u.length;) {
            r = k = u.pop();
            if (w.relative[k]) r = u.pop(); else k = "";
            if (r == null) r = j;
            w.relative[k](x, r, y)
          }
        } else x = []
      ...
      x || s.error(k ||
        h);
      if (g.call(x) === "[object Array]") if (t) if (j && j.nodeType === 1) for (h = 0; x[h] != null; h++) {
        if (x[h] && (x[h] === true || x[h].nodeType === 1 && s.contains(j, x[h]))) n.push(C[h])
      } else for (h = 0; x[h] != null; h++) x[h] && x[h].nodeType === 1 && n.push(C[h]); else n.push.apply(n, x); else K(x, n);
      if (H) {
        s(H, q, n, o);
        s.uniqueSort(n)
      }
    ...
    s.filter = function (h, j, n, o) {
      for (var q, r, C, x, H, k, t, y, u = h, E = [], D = j, L = j && j[0] && s.isXML(j[0]); h &&
      j.length;) {
        for (C in w.filter) if ((q = w.leftMatch[C].exec(h)) != null && q[2]) {
          k = w.filter[C];
          H = q[1];
          r = false;
          q.splice(1, 1);
          if (H.substr(H.length - 1) !== "\\") {
            if (D === E) E = [];
            if (w.preFilter[C]) if (q = w.preFilter[C](q, D, n, E, o, L)) {
              if (q === true) continue
            } else r = x = true;
            if (q) for (t = 0; (H = D[t]) != null; t++) if (H) {
              x = k(H, q, t, D);
              y = o ^ x;
              if (n && x != null) if (y) r = true; else D[t] = false; else if (y) {
                E.push(H);
                r = true
              }
            }
        ...
        if (h === u) if (r == null) s.error(h); else break;
        u = h
      }
      return D
    };
    ...
    var A = s.getText = function (h) {
      ...
      j = h.nodeType;
      var o = "";
      if (j) if (j === 1 || j === 9) if (typeof h.textContent === "string") return h.textContent; else if (typeof h.innerText === "string") return h.innerText.replace(p, ""); else for (h = h.firstChild; h; h = h.nextSibling) o += A(h); else {
      ...
      leftMatch: {}, attrMap: {"class": "className", "for": "htmlFor"}, attrHandle: {
        ...
        "+": function (h, j) {
          var n = typeof j === "string", o = n && !v.test(j);
          n = n && !o;
          if (o) j = j.toLowerCase();
          o = 0;
          for (var q = h.length, r; o < q; o++) if (r = h[o]) {
            for (; (r = r.previousSibling) && r.nodeType !== 1;) ;
            h[o] = n || r && r.nodeName.toLowerCase() === j ? r || false : r === j
          }
          n && s.filter(j, h, true)
        }, ">": function (h, j) {
          var n, o = typeof j === "string", q = 0, r = h.length;
          if (o &&
            !v.test(j)) for (j = j.toLowerCase(); q < r; q++) {
            if (n = h[q]) {
              n = n.parentNode;
        ...
        ID: function (h, j, n) {
          if (typeof j.getElementById !==
            "undefined" && !n) return (h = j.getElementById(h[1])) && h.parentNode ? [h] : []
        }, NAME: function (h, j) {
        ...
        CLASS: function (h, j, n, o, q, r) {
          ...
          if (r) return h;
          r = 0;
          for (var C; (C = j[r]) != null; r++) if (C) if (q ^
            (C.className && (" " + C.className + " ").replace(/[\t\n\r]/g, " ").indexOf(h) >= 0)) n || o.push(C); else if (n) j[r] = false;
          return false
        }, ID: function (h) {
        ...
        ATTR: function (h, j, n, o, q, r) {
          ...
          if (h[1] === "not") if ((d.exec(h[3]) || "").length > 1 || /^\w/.test(h[3])) h[3] = s(h[3], null, null, j); else {
        ...
        enabled: function (h) {
          ...
          var j = h.getAttribute("type"), n = h.type;
        ...
        PSEUDO: function (h, j, n, o) {
          var q = j[1], r = w.filters[q];
          if (r) return r(h, n, j, o); else if (q === "contains") return (h.textContent || h.innerText || A([h]) || "").indexOf(j[3]) >= 0; else if (q === "not") {
            j = j[3];
            n = 0;
          ...
          return j === "*" && h.nodeType === 1 || !!h.nodeName && h.nodeName.toLowerCase() ===
            j
        }, CLASS: function (h, j) {
          ...
          var o = n + "", q = j[2], r = j[4];
          return n == null ? q === "!=" : !q && s.attr ? n != null : q === "=" ? o === r : q === "*=" ? o.indexOf(r) >= 0 : q === "~=" ? (" " + o + " ").indexOf(r) >= 0 : !r ? o && n !== false : q === "!=" ? o !== r : q === "^=" ? o.indexOf(r) === 0 : q === "$=" ? o.substr(o.length - r.length) === r : q === "|=" ? o === r || o.substr(0, r.length + 1) === r + "-" : false
        },
    ...
    try {
      ...
      K = function (h, j) {
        var n = 0, o = j ||
          [];
        if (g.call(h) === "[object Array]") Array.prototype.push.apply(o, h); else if (typeof h.length === "number") for (var q = h.length; n < q; n++) o.push(h[n]); else for (; h[n]; n++) o.push(h[n]);
        return o
      }
    }
    var O, G;
    if (B.documentElement.compareDocumentPosition) O = function (h, j) {
      if (h === j) {
        i = true;
        return 0
      }
    ...
    (function () {
      var h = B.createElement("div"), j = "script" + (new Date).getTime(),
        n = B.documentElement;
      h.innerHTML = "<a name='" + j + "'/>";
      n.insertBefore(h, n.firstChild);
      if (B.getElementById(j)) {
        w.find.ID = function (o, q, r) {
          if (typeof q.getElementById !== "undefined" && !r) return (q = q.getElementById(o[1])) ? q.id === o[1] || typeof q.getAttributeNode !== "undefined" && q.getAttributeNode("id").nodeValue === o[1] ? [q] : z : []
        };
    ...
    (function () {
      ...
      if (h.getElementsByTagName("*").length > 0) w.find.TAG = function (j, n) {
      ...
      if (h.firstChild && typeof h.firstChild.getAttribute !== "undefined" && h.firstChild.getAttribute("href") !== "#") w.attrHandle.href = function (j) {
        return j.getAttribute("href", 2)
      };
      h = null
    })();
    B.querySelectorAll && function () {
      var h = s, j = B.createElement("div");
      ...
      if (!(j.querySelectorAll && j.querySelectorAll(".TEST").length === 0)) {
        s = function (o, q, r, C) {
          ...
          if (!C && !s.isXML(q)) {
            var x = /^(\w+$)|^\.([\w\-]+$)|^#([\w\-]+$)/.exec(o);
            if (x && (q.nodeType === 1 || q.nodeType === 9)) if (x[1]) return K(q.getElementsByTagName(o), r); else if (x[2] && w.find.CLASS && q.getElementsByClassName) return K(q.getElementsByClassName(x[2]), r);
            if (q.nodeType === 9) {
              if (o === "body" && q.body) return K([q.body], r); else if (x && x[3]) {
              ...
              x = q;
              var t = (H = q.getAttribute("id")) || "__sizzle__", y = q.parentNode, u = /^\s*[+~]/.test(o);
              if (H) t = t.replace(/'/g, "\\$&"); else q.setAttribute("id", t);
    ...
    (function () {
      ...
      if (j) {
        var n = !j.call(B.createElement("div"), "div"), o = false;
        try {
    ...
    s.contains = B.documentElement.contains ? function (h, j) {
  ...
  var Lb = /Until$/, Mb = /^(?:parents|prevUntil|prevAll)/, Nb = /,/, tb = /^.[^:#\[\.,]*$/, Ob = Array.prototype.slice, ab = c.expr.match.POS, Pb = {children: true, contents: true, next: true, prev: true};
  c.fn.extend({
    find: function (a) {
      var b = this, d, e;
      ...
      for (e = this.length; d < e; d++) {
        ...
        c.find(a, this[d],
          f);
        if (d > 0) for (i = g; i < f.length; i++) for (l = 0; l < g; l++) if (f[l] === f[i]) {
          f.splice(i--, 1);
          break
        }
      }
      ...
      return !!a && (typeof a === "string" ? ab.test(a) ? c(a, this.context).index(this[0]) >= 0 : c.filter(a, this).length > 0 : this.filter(a).length >
        0)
  ...
  var Ga = "abbr|article|aside|audio|canvas|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
    Qb = / jQuery\d+="(?:\d+|null)"/g, xa = /^\s+/, bb = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, cb = /<([\w:]+)/, Rb = /<tbody/i, Sb = /<|&#?\w+;/, Tb = /<(?:script|style)/i, Ub = /<(?:script|object|embed|option|style)/i, db = RegExp("<(?:" + Ga + ")", "i"), eb = /checked\s*(?:[^=]|=\s*.checked.)/i, Vb = /\/(java|ecma)script/i, vb = /^\s*<!(?:\[CDATA\[|\-\-)/, P = {
      option: [1, "<select multiple='multiple'>", "</select>"], legend: [1, "<fieldset>", "</fieldset>"], thead: [1, "<table>", "</table>"], tr: [2, "<table><tbody>",
        "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], col: [2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"], area: [1, "<map>", "</map>"], _default: [0, "", ""]
    }, fb = Fa(B);
  P.optgroup = P.option;
  ...
  c.fn.extend({
    text: function (a) {
      ...
      if (typeof a !== "object" && a !== z) return this.empty().append((this[0] &&
        this[0].ownerDocument || B).createTextNode(a));
      return c.text(this)
    }, wrapAll: function (a) {
      ...
      if (a === z) return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(Qb, "") : null; else if (typeof a === "string" && !Tb.test(a) && (c.support.leadingWhitespace || !xa.test(a)) && !P[(cb.exec(a) || ["", ""])[1].toLowerCase()]) {
        a = a.replace(bb, "<$1></$2>");
        try {
      ...
      if (c.isFunction(i)) return this.each(function (v) {
        var s = c(this);
      ...
      if (this[0]) {
        ...
        if (f = g.childNodes.length === 1 ? g = g.firstChild : g.firstChild) {
          b = b && c.nodeName(f, "tr");
          f = 0;
          for (var m = this.length, p = m - 1; f < m; f++) d.call(b ? c.nodeName(this[f], "table") ? this[f].getElementsByTagName("tbody")[0] || this[f].appendChild(this[f].ownerDocument.createElement("tbody")) : this[f] : this[f], e.cacheable || m > 1 && f < p ? c.clone(g, true, true) : g)
        }
  ...
  c.buildFragment = function (a, b, d) {
    ...
    i.createDocumentFragment || (i =
      B);
    if (a.length === 1 && typeof l === "string" && l.length < 512 && i === B && l.charAt(0) === "<" && !Ub.test(l) && (c.support.checkClone || !eb.test(l)) && (c.support.html5Clone || !db.test(l))) {
      f = true;
  ...
  c.extend({
    clone: function (a, b, d) {
      var e, f, g;
      if (c.support.html5Clone || !db.test("<" + a.nodeName)) e = a.cloneNode(true); else {
      ...
      if ((!c.support.noCloneEvent ||
        !c.support.noCloneChecked) && (a.nodeType === 1 || a.nodeType === 11) && !c.isXMLDoc(a)) {
        Ia(a, i);
        e = ia(a);
        f = ia(i);
      ...
      for (var f = [], g, i = 0, l; (l = a[i]) != null; i++) {
        ...
        if (l) {
          if (typeof l === "string") if (Sb.test(l)) {
            l = l.replace(bb, "<$1></$2>");
            g = (cb.exec(l) || ["", ""])[1].toLowerCase();
            var m = P[g] || P._default, p = m[0], v = b.createElement("div");
            ...
            b.createTextNode(l);
          var s;
          if (!c.support.appendChecked) if (l[0] && typeof (s = l.length) === "number") for (g = 0; g < s; g++) Ka(l[g]); else Ka(l);
    ...
    cleanData: function (a) {
      for (var b, d, e = c.cache, f = c.event.special, g = c.support.deleteExpando, i = 0, l; (l = a[i]) != null; i++) if (!(l.nodeName && c.noData[l.nodeName.toLowerCase()])) if (d = l[c.expando]) {
        if ((b = e[d]) && b.events) {
          for (var m in b.events) f[m] ? c.event.remove(l, m) : c.removeEvent(l, m, b.handle);
          if (b.handle) b.handle.elem = null
        }
        if (g) delete l[c.expando]; else l.removeAttribute && l.removeAttribute(c.expando);
        delete e[d]
      }
    }
  });
  var ya = /alpha\([^)]*\)/i, Wb = /opacity=([^)]*)/, Xb = /([A-Z]|^ms)/g, gb = /^-?\d+(?:px)?$/i, Yb = /^-?\d/,
    Zb = /^([\-+])=([\-+.\de]+)/, $b = {position: "absolute", visibility: "hidden", display: "block"}, wb = ["Left", "Right"], xb = ["Top", "Bottom"], aa, hb, ib;
  ...
  c.extend({
    cssHooks: {
      ...
      fillOpacity: true, fontWeight: true, lineHeight: true, opacity: true, orphans: true,
      ...
      if (!(!a || a.nodeType === 3 || a.nodeType === 8 || !a.style)) {
        ...
        if (d !== z) {
          ...
          if (!(d == null || e === "number" && isNaN(d))) {
            ...
            if (!l || !("set" in l) || (d = l.set(a, d)) !== z) try {
              i[b] = d
            } catch (m) {
            }
          }
          ...
          if (l &&
            "get" in l && (f = l.get(a, false, e)) !== z) return f;
          return i[b]
        }
      }
    }, css: function (a, b, d) {
      ...
      if (f && "get" in f && (e = f.get(a, true, d)) !== z) return e; else if (aa) return aa(a, b)
    }, swap: function (a, b, d) {
      var e = {};
      for (var f in b) {
        e[f] = a.style[f];
  ...
  if (!c.support.opacity) c.cssHooks.opacity = {
    get: function (a, b) {
      ...
      var d = a.style, e = a.currentStyle, f = c.isNumeric(b) ? "alpha(opacity=" + b * 100 + ")" : "", g = e && e.filter || d.filter || "";
      d.zoom = 1;
  ...
  if (B.defaultView && B.defaultView.getComputedStyle) hb = function (a, b) {
    var d, e, f;
    b = b.replace(Xb, "-$1").toLowerCase();
    if ((e = a.ownerDocument.defaultView) && (f = e.getComputedStyle(a, null))) {
      d = f.getPropertyValue(b);
      if (d === "" && !c.contains(a.ownerDocument.documentElement,
        a)) d = c.style(a, b)
    }
    return d
  };
  if (B.documentElement.currentStyle) ib = function (a, b) {
  ...
  if (c.expr && c.expr.filters) {
    c.expr.filters.hidden = function (a) {
      ...
      return a.offsetWidth ===
        0 && b === 0 || !c.support.reliableHiddenOffsets && (a.style && a.style.display || c.css(a, "display")) === "none"
    };
  ...
  var ac = /%20/g, yb = /\[\]$/, jb = /\r?\n/g, bc = /#.*$/, cc = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, dc = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, ec = /^(?:GET|HEAD)$/, fc = /^\/\//, kb = /\?/, gc = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, hc = /^(?:select|textarea)/i, Na = /\s+/,
    ic = /([?&])_=[^&]*/, lb = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, mb = c.fn.load, ra = {}, nb = {}, X, Y, ob = ["*/"] + ["*"];
  try {
    X = Bb.href
  } catch (qc) {
    X = B.createElement("a");
  ...
  c.fn.extend({
    load: function (a, b, d) {
      ...
      var g = this;
      c.ajax({
        url: a, type: e, dataType: "html", data: b, complete: function (i, l, m) {
          m = i.responseText;
          if (i.isResolved()) {
            i.done(function (p) {
              m = p
      ...
      return this.map(function () {
        ...
        return this.name && !this.disabled && (this.checked || hc.test(this.nodeName) ||
          dc.test(this.type))
      }).map(function (a, b) {
        var d = c(this).val();
  ...
  c.extend({
    getScript: function (a, b) {
      ...
      url: X, isLocal: /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/.test(Y[1]), global: true, type: "GET", contentType: "application/x-www-form-urlencoded", processData: true, async: true, accepts: {
        xml: "application/xml, text/xml", html: "text/html", text: "text/plain", json: "application/json, text/javascript",
        "*": ob
      }, contents: {xml: /xml/, html: /html/, json: /json/}, responseFields: {xml: "responseXML", text: "responseText"}, converters: {"* text": I.String, "text html": true, "text json": c.parseJSON, "text xml": c.parseXML}, flatOptions: {context: true, url: true}
    }, ajaxPrefilter: Ma(ra), ajaxTransport: Ma(nb), ajax: function (a, b) {
      function d(j, n, o, q) {
        if (K !== 2) {
          K = 2;
          J && clearTimeout(J);
          ...
          q = n;
          if (o) {
            var H = e, k = G, t = H.contents, y = H.dataTypes, u = H.responseFields, E, D, L, N;
            for (D in u) if (D in o) k[u[D]] =
              o[D];
            for (; y[0] === "*";) {
              y.shift();
              if (E === z) E = H.mimeType || k.getResponseHeader("content-type")
            }
            if (E) for (D in t) if (t[D] && t[D].test(E)) {
              y.unshift(D);
              break
            }
            if (y[0] in o) L = y[0]; else {
              for (D in o) {
              ...
              for (ga = 1; ga < jc; ga++) {
                ...
                if (U === "*") U = da; else if (da !== "*" && da !== U) {
                  ...
                  if (!V) {
                    ...
                    for (Z in D) {
                      na = Z.split(" ");
                      if (na[0] === da || na[0] === "*") if (ea = D[na[1] + " " + U]) {
                        Z = D[Z];
                        if (Z === true) V = ea; else if (ea === true) V = Z;
                        break
                      }
                    }
                  }
                  V || ea || c.error("No conversion from " + za.replace(" ",
                    " to "));
      ...
      b = b || {};
      var e = c.ajaxSetup({}, b), f = e.context || e, g = f !== e && (f.nodeType || f instanceof
        c) ? c(f) : c.event, i = c.Deferred(), l = c.Callbacks("once memory"), m = e.statusCode || {}, p, v = {}, s = {}, A, w, F, J, M, K = 0, T, O, G = {
        readyState: 0, setRequestHeader: function (j, n) {
          if (!K) {
            var o = j.toLowerCase();
            j = s[o] = s[o] || j;
            v[j] = n
      ...
      G.statusCode = function (j) {
        if (j) {
          var n;
          if (K < 2) for (n in j) m[n] = [m[n], j[n]]; else {
            n = j[G.status];
            G.then(n, n)
          }
        }
      ...
      e.dataTypes = c.trim(e.dataType || "*").toLowerCase().split(Na);
      if (e.crossDomain == null) {
        M = lb.exec(e.url.toLowerCase());
        e.crossDomain = !!(M && (M[1] != Y[1] || M[2] != Y[2] || (M[3] || (M[1] === "http:" ? 80 : 443)) != (Y[3] || (Y[1] === "http:" ? 80 : 443))))
      }
      if (e.data &&
        e.processData && typeof e.data !== "string") e.data = c.param(e.data, e.traditional);
      ja(ra, e, b, G);
      if (K === 2) return false;
      T = e.global;
      ...
      if (e.data && e.hasContent && e.contentType !== false || b.contentType) G.setRequestHeader("Content-Type",
        e.contentType);
      if (e.ifModified) {
        p = p || e.url;
      ...
      G.setRequestHeader("Accept", e.dataTypes[0] && e.accepts[e.dataTypes[0]] ? e.accepts[e.dataTypes[0]] + (e.dataTypes[0] !== "*" ? ", " + ob + "; q=0.01" : "") : e.accepts["*"]);
      for (O in e.headers) G.setRequestHeader(O, e.headers[O]);
      if (e.beforeSend && (e.beforeSend.call(f, G, e) === false || K === 2)) {
        G.abort();
        return false
      }
      for (O in {success: 1, error: 1, complete: 1}) G[O](e[O]);
      if (F = ja(nb, e, b, G)) {
        G.readyState = 1;
        T && g.trigger("ajaxSend", [G, e]);
        if (e.async && e.timeout > 0) J = setTimeout(function () {
          G.abort("timeout")
        }, e.timeout);
        try {
          K = 1;
  ...
  c.ajaxPrefilter("json jsonp", function (a, b, d) {
    ...
    if (a.dataTypes[0] === "jsonp" || a.jsonp !== false && (oa.test(a.url) || b && oa.test(a.data))) {
      var e, f = a.jsonpCallback = c.isFunction(a.jsonpCallback) ? a.jsonpCallback() : a.jsonpCallback,
        g = I[f], i = a.url, l = a.data, m = "$1" + f + "$2";
      if (a.jsonp !== false) {
        i = i.replace(oa, m);
        if (a.url === i) {
  ...
  c.ajaxTransport("script", function (a) {
    if (a.crossDomain) {
      var b, d = B.head || B.getElementsByTagName("head")[0] || B.documentElement;
      return {
        send: function (e, f) {
  ...
  var Aa = I.ActiveXObject ? function () {
    for (var a in fa) fa[a](0, 1)
  } : false, mc = 0, fa;
  c.ajaxSettings.xhr = I.ActiveXObject ? function () {
    var a;
    ...
    if (!a.crossDomain || c.support.cors) {
      ...
      return {
        send: function (d, e) {
          ...
          try {
            for (i in d) f.setRequestHeader(i,
              d[i])
          } catch (l) {
          }
          ...
          b = function (m, p) {
            ...
            try {
              if (b && (p || f.readyState === 4)) {
                ...
                if (p) f.readyState !== 4 && f.abort(); else {
                  v = f.status;
                  ...
                  if (!v && a.isLocal && !a.crossDomain) v = w.text ? 200 : 404; else if (v === 1223) v = 204
                }
              }
            } catch (M) {
              p || e(-1, M)
  ...
  var ta = {}, R, ca, nc = /^(?:toggle|show|hide)$/, oc = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, pa, Ra = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]], ka;
  c.fn.extend({
    show: function (a, b, d) {
      ...
      if (a || a === 0) return this.animate(ba("hide", 3), a, b, d); else {
        ...
        for (d =
               0; d < e; d++) if (this[d].style) this[d].style.display = "none";
        return this
      }
      ...
      function f() {
        g.queue ===
        false && c._mark(this);
        var i = c.extend({}, g), l = this.nodeType === 1, m = l && c(this).is(":hidden"), p, v, s, A, w;
        ...
        for (s in a) {
          ...
          if (l && (p === "height" || p === "width")) {
            ...
            if (c.css(this, "display") === "inline" && c.css(this, "float") === "none") if (!c.support.inlineBlockNeedsLayout || Sa(this.nodeName) === "inline") this.style.display = "inline-block"; else this.style.zoom = 1
          }
        }
        ...
        for (s in a) {
          l = new c.fx(this, i, s);
          v = a[s];
          if (nc.test(v)) if (p = c._data(this, "toggle" + s) || (v === "toggle" ? m ? "show" : "hide" : 0)) {
      ...
      return this.each(function () {
        ...
        var f, g = false, i = c.timers, l = c._data(this);
        d || c._unmark(true, this);
        if (a == null) for (f in l) l[f] && l[f].stop && f.indexOf(".run") === f.length - 4 && e(this, l, f); else if (l[f = a + ".run"] && l[f].stop) e(this, l, f);
        for (f = i.length; f--;) if (i[f].elem === this && (a == null || i[f].queue === a)) {
  ...
  c.each({slideDown: ba("show", 1), slideUp: ba("hide", 1), slideToggle: ba("toggle", 1), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (a,
                                                                                                                                                                                             b) {
  ...
  c.extend({
    speed: function (a, b, d) {
      ...
      e.complete = function (f) {
        ...
        if (e.queue) c.dequeue(this,
          e.queue); else f !== false && c._unmark(this)
      };
      return e
    }, easing: {
  ...
  c.fx.prototype = {
    update: function () {
      ...
      if (e() && c.timers.push(e) && !pa) pa = setInterval(g.tick,
        g.interval)
    }, show: function () {
      ...
      var b, d = ka || Qa(), e = true, f = this.elem, g = this.options;
      if (a || d >= g.duration + this.startTime) {
        ...
        if (e) {
          g.overflow != null && !c.support.shrinkWrapBlocks && c.each(["", "X", "Y"], function (i, l) {
        ...
        if (g.duration == Infinity) this.now = d; else {
          a = d - this.startTime;
  ...
  var pc = /^t(?:able|d|h)$/i, pb = /^(?:body|html)$/i;
  c.fn.offset = "getBoundingClientRect" in
  B.documentElement ? function (a) {
    var b = this[0], d;
    ...
    f = ua(f);
    return {
      top: d.top + (f.pageYOffset || c.support.boxModel && g.scrollTop || b.scrollTop) - (g.clientTop || b.clientTop || 0), left: d.left + (f.pageXOffset ||
        c.support.boxModel && g.scrollLeft || b.scrollLeft) - (g.clientLeft || b.clientLeft || 0)
    }
  } : function (a) {
    var b = this[0];
  ...
  c.offset = {
    bodyOffset: function (a) {
      ...
      if (e === "static") a.style.position =
        "relative";
      var f = c(a), g = f.offset(), i = c.css(a, "top"), l = c.css(a, "left"), m = {}, p = {};
  ...
  c.fn.extend({
    position: function () {
      ...
      var a = this[0], b = this.offsetParent(), d = this.offset(), e = pb.test(b[0].nodeName) ?
  ...
  c.each(["Left", "Top"], function (a, b) {
    ...
    c.fn[d] = function (e) {
      ...
      if (e === z) {
        f = this[0];
        if (!f) return null;
        return (g = ua(f)) ? "pageXOffset" in g ? g[a ? "pageYOffset" : "pageXOffset"] : c.support.boxModel && g.document.documentElement[d] || g.document.body[d] : f[d]
      }
      return this.each(function () {
        if (g = ua(this)) g.scrollTo(!a ? e : c(g).scrollLeft(), a ? e : c(g).scrollTop()); else this[d] = e
      })
    }
  });
  c.each(["Height", "Width"], function (a, b) {
    ...
    c.fn[d] = function (e) {
      ...
      if (c.isWindow(f)) {
        var g = f.document.documentElement["client" + b], i = f.document.body;
        return f.document.compatMode === "CSS1Compat" && g || i && i["client" + b] || g
      } else if (f.nodeType === 9) return Math.max(f.documentElement["client" + b], f.body["scroll" + b], f.documentElement["scroll" +
      b], f.body["offset" + b], f.documentElement["offset" + b]); else if (e === z) {
        f = c.css(f, d);
        g = parseFloat(f);
