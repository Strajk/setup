$.ajaxTransport("+binary", function (a, b, c) {
  if (window.FormData && (a.dataType && a.dataType == "binary" || a.data && (window.ArrayBuffer && a.data instanceof ArrayBuffer || window.Blob && a.data instanceof Blob))) return {
    send: function (d, e) {
      var f = new XMLHttpRequest, h = a.url, i = a.type, j = a.responseType || "blob", k = a.data || null;
...
var Web = {
  getCommonSharableLink: function (a) {
    var b = this, c = "", d = "";
    return b.getUploadUrl(a).then(function (e) {
      c = e.VisitUrl;
      d = e.Id;
    ...
    return new Promise(function (c, d) {
      $.ajax({
        type: "GET", url: "https://www.diigo.com/share_annotation/presign", data: b, dataType: "json", success: function (e) {
          c(e)
        }, error: function () {
    ...
    return new Promise(function (d, e) {
      $.ajax({
        type: "PUT", url: a, headers: {"Content-Type": b, "content-encoding": "utf-8", "x-amz-meta-key": "REPLACE"}, data: c, processData: false, success: function (f) {
          d(f)
        },
        error: function () {
          e("Upload file error")
    ...
    return new Promise(function (b, c) {
      ...
      d.append("pdf", a.file);
      $.ajax({
        type: "POST", url: "https://www.diigo.com/share_annotation/pdfwithann", data: d, dataType: "binary", processData: false, contentType: false, success: function (e) {
          b(e)
        }, error: function (e) {
          c(e)
        }
    ...
    return Promise.all([this.uploadFile(a.PresignedUrl, "application/pdf",
      b), this.uploadFile(d, "application/json", c)]).then(function () {
