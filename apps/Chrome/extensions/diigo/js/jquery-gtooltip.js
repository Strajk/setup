(function (c) {
  ...
  c.fn.Gtooltip = function (s) {
    var t = {fontSize: 12, bgColor: "black", fColor: "white", position: "bottom", content: ""};
    return this.each(function () {
      function q() {
        l.text(e.data("gtooltip"));
        var a;
        a = e.offset().left;
        var r = e.offset().top, i = e.width(), u = e.height(), f = b.width(), v = b.height(), j, d, m, n, g = navigator.userAgent.toLowerCase();
        ...
        a = {atop: n, aleft: j, left: a, tleft: d, ttop: m};
        b.css("left", a.tleft).css("top", a.ttop);
        k.css({left: a.aleft, top: a.atop});
        if (o.position == "top") k.css("-webkit-transform", "rotate(180deg)"); else o.position == "bottom" && k.css("-webkit-transform", "rotate(360deg)");
        b.addClass("show")
      }

      var o = c.extend(t, s || {}), e = c(this), b, l, k;
      if (c("#gtooltip").length ==
        0) {
