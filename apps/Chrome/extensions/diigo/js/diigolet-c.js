if (window.diigolet == undefined) {
  ...
  try {
    (function () {
      ...
      var ta = [Array.prototype, ["slice", "push", "indexOf"], String.prototype, ["trim"]], la, ha, N, Aa, M;
      la = 0;
  ...
  (function () {
    function wa(a, c) {
      try {
        Na.indexOf(c) >= Na.indexOf(x.logLevel) && window.console &&
    ...
    function M() {
      for (var a = [].slice.call(arguments), c = a.shift(), d = 0, f = a.length, h; h = a[d], d < f; d++) for (var i in h) c[i] =
        h[i];
      return c
    }
    ...
    function Oa(a, c, d) {
      for (var f = 0, h = a.length; f < h; f++) if (c.call(d,
        a[f], f)) return true;
      return false
    }
    ...
    function Qa(a, c) {
      for (var d = [], f = 0, h = a.length, i; i = a[f], f < h; f++) if (c) oa(d, function (m) {
        return c(m, i)
    ...
    function bb(a) {
      for (var c = Array(a.length),
             d = a.length - 1, f = 0; d >= 0; d--, f++) c[f] = a[d];
      return c
    }
    ...
    function Ta(a) {
      var c = {
        aqua: [0, 255, 255], azure: [240, 255, 255], beige: [245, 245, 220], black: [0, 0, 0], blue: [0, 0, 255], brown: [165, 42,
          42], cyan: [0, 255, 255], darkblue: [0, 0, 139], darkcyan: [0, 139, 139], darkgrey: [169, 169, 169], darkgreen: [0, 100, 0], darkkhaki: [189, 183, 107], darkmagenta: [139, 0, 139], darkolivegreen: [85, 107, 47], darkorange: [255, 140, 0], darkorchid: [153, 50, 204], darkred: [139, 0, 0], darksalmon: [233, 150, 122], darkviolet: [148, 0, 211], fuchsia: [255, 0, 255], gold: [255, 215, 0], green: [0, 128, 0], indigo: [75, 0, 130], khaki: [240, 230, 140], lightblue: [173, 216, 230], lightcyan: [224, 255, 255], lightgreen: [144, 238, 144], lightgrey: [211, 211, 211], lightpink: [255, 182, 193],
        lightyellow: [255, 255, 224], lime: [0, 255, 0], magenta: [255, 0, 255], maroon: [128, 0, 0], navy: [0, 0, 128], olive: [128, 128, 0], orange: [255, 165, 0], pink: [255, 192, 203], purple: [128, 0, 128], red: [255, 0, 0], silver: [192, 192, 192], white: [255, 255, 255], yellow: [255, 255, 0]
      };
      return c[a] ? {r: c[a][0], g: c[a][1], b: c[a][2]} : (result = /^rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)$/.exec(a)) ? {r: parseInt(result[1]), g: parseInt(result[2]), b: parseInt(result[3])} : (result = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)$/.exec(a)) ?
        {r: parseFloat(result[1]) * 2.55, g: parseFloat(result[2]) * 2.55, b: parseFloat(result[3]) * 2.55} : (result = /^#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])$/.exec(a)) ? {r: parseInt("0x" + result[1] + result[1]), g: parseInt("0x" + result[2] + result[2]), b: parseInt("0x" + result[3] + result[3])} : (result = /^#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})$/.exec(a)) ? {r: parseInt("0x" + result[1]), g: parseInt("0x" + result[2]), b: parseInt("0x" + result[3])} : {r: 255, g: 255, b: 255}
    }
    ...
    function Ua(a) {
      ...
      for (c = ""; d < f;) {
        ...
        if (d == f) {
          ...
          c += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((i &
            15) << 2);
          c += "=";
          break
        }
    ...
    function da() {
      return ia() || (H.notify(diigolet.consts.MSG_NEED_TO_SIGNIN,
        5E3), false)
    }
    ...
    function Wa() {
      ...
      typeof document.addEventListener === "undefined" || typeof a === "undefined" ||
    ...
    function eb() {
      J([R, B, H, Y, P, X, U, Xa, V], function (a) {
        if (a.j) {
          ...
          a.j.unbind().bind("mouseup", c).bind("mousedown", c).bind("keydown", function (d) {
            d.stopPropagation()
          })
        }
      });
      Fa.mousedown(function (a) {
        if (a.target.tagName == "INPUT" || a.target.tagName == "TEXTAREA") Ga = true; else if (a.target.id == "diigolet-csm-dropdown" || a.target.className == "diigolet-csm-coloritem" || a.target.parentNode.id == "diigolet-panel-btnHighlight") ya = true;
        window.getSelection();
        mousedownTop = a.pageY;
        mousedownLeft = a.pageX
      }).mouseup(fb).mouseover(gb).mouseout(hb).mousemove(function (a) {
    ...
    function jb() {
      new kb("#Diigo-Bookmark-Tag", {
        resultsClass: "diigolet ac_results", data: k.myTags, mode: "multiple", multipleSeparator: " ,", onItemSelect: function () {
          R.clickedOn = true
        }
      })
    }
      ...
      if (!k.draggingFloatNote) {
        ...
        if (d) {
          ...
          if (c != null) {
            c.activate(true);
            if (d.type ==
              diigolet.consts.ANNOTATION_TYPE_TEXT || d.type == diigolet.consts.ANNOTATION_TYPE_IMAGE) {
              Z.reset(c);
              P.scheduleShow(a, c)
            }
    ...
    function fb(a) {
      ...
      if (!Ga && !ya && Ba.isTextSelected() && k.isOwner) if (k.isHighlightPen) diigolet.handle(a,
        "highlight"); else {
    ...
    function mb() {
      ...
      a = function (m) {
        ...
        if (l.test(m)) return m.replace(l, function (r) {
          return "\\" +
      ...
      d += c[1];
      document.createStyleSheet ? document.createStyleSheet().cssText = d : $("head, body").add(document.body).eq(0).append($(document.createElement("style")).attr({type: "text/css"}).text(d))
    }
    ...
    var x = window.diigolet = {
      debug: false, logLevel: "error", version: "5.0b4", show: function () {
        H.show()
      },
      callback: function () {
    ...
    (function (a) {
        ...
        if (m != "undefined") {
          ...
          if (m == "object") {
            ...
            if (i.constructor === Date) {
              ...
              m = i.getUTCDate();
              if (m < 10) m = "0" + m;
              var r = i.getUTCFullYear(), y = i.getUTCHours();
              if (y < 10) y = "0" + y;
      ...
      a.secureEvalJSON = function (i) {
        ...
        m = m.replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
          "]");
        m = m.replace(/(?:^|:|,)(?:\s*\[)+/g, "");
        if (/^[\],:{}\s]*$/.test(m)) return eval("(" + i + ")"); else throw new SyntaxError("Error parsing JSON, source is not valid.");
      };
      a.quoteString = function (i) {
        if (i.match(f)) return '"' + i.replace(f, function (m) {
          var l = h[m];
    ...
    A.lang = {
      isArray: function (a) {
        ...
        for (var a = [].slice.call(arguments), c = a.shift(), d = a.pop(), f = 0, h = a.length, i; i = a[f], f < h; f++) for (var m in i) {
          var l = d(m);
    ...
    A.array = {
      findIndex: function (a, c, d) {
        ...
        for (var d = [], f = 0, h = a.length, i; i = a[f], f < h; f++) if (c) this.find(d, function (m) {
          return c(m, i)
        }) || d.push(i); else d.indexOf(i) == -1 && d.push(i);
        return d
      }, reverse: function (a) {
    ...
    A.string = {
      md5: function (a) {
        ...
        A.each(a, function (f, h) {
          if (h) if (f && typeof f == "object") A.isArray(f) && A.each(f, function (i) {
            c(h, i)
          }); else c(h, f)
        });
        return d.join("&")
    ...
    A.dom = {
      build2: function () {
        ...
        return window.getSelection ?
          window.getSelection().toString() : document.getSelection ? document.getSelection() : document.selection.createRange().text
    ...
    va.URLParser.prototype._parse = function (a) {
      ...
      for (var c in this._fields) if (typeof a[this._fields[c]] !=
        "undefined") this._values[c] = a[this._fields[c]]
    };
    ...
    T.extend = function (a, c) {
      ...
      var h = f.constructor, i = f.constructor = function () {
        if (!T._prototyping) if (this._constructing || this.constructor == i) {
          this._constructing = true;
          h.apply(this, arguments);
          delete this._constructing
        } else if (arguments[0] != null) return (arguments[0].extend ||
          d).call(arguments[0], f)
      };
      i.ancestor = this;
    ...
    T.prototype = {
      extend: function (a, c) {
        if (arguments.length > 1) {
          ...
          for (var i = {toSource: null}, m = ["constructor", "toString", "valueOf"], l = T._prototyping ? 0 : 1; r = m[l++];) a[r] != i[r] && h.call(this, r, a[r]);
    ...
    jQuery.Draggable = function (a, c) {
      ...
      function f(z) {
        ...
        var w = parseInt(a.css("left")),
          o = parseInt(a.css("top")), p = z.pageX - r, n = z.pageY - y;
    ...
    var kb = function (a, c) {
          ...
          switch (p.keyCode) {
            ...
            default:
              ...
              z = setTimeout(function () {
                if (y.val().length < w.minChars) o.hide(); else a:{
                  var n = y.val();
                  if (w.mode == "multiple") {
                    var q = d(n), t = "";
        ...
        function i(p) {
          ...
          if (!(p < 0)) {
            ...
            y.val(new_value);
            o.hide();
            w.onItemSelect && setTimeout(function () {
              w.onItemSelect(n)
            }, 1);
            setTimeout(function () {
              y[0].focus();
        ...
        function m(p) {
          ...
          if (n.size() !=
            0) {
            active += p;
            if (active < 0) active = n.size() - 1; else if (active >= n.size()) active = 0;
        ...
        function l(p, n) {
          if (n && n.length > 0) {
            ...
            o.find("li").unbind();
            o.find("ul").html($.map(n, function (t) {
              return "<li>" + t + "</li>"
            }).join("")).end().css({
              top: q.y +
                y[0].offsetHeight, left: q.x
            }).show();
            o.find("li").mouseover(function (t) {
        ...
        var w = c = $.extend({
          inputClass: "ac_input", resultsClass: "ac_results", minChars: 1, delay: 100, matchCase: 0, matchSubset: 1, matchContains: 0, mustMatch: 0, loadingClass: "ac_loading", selectFirst: false,
          selectOnly: false, mode: "multiple", multipleSeparator: " "
        }, c || {});
    ...
    diigolet.consts = {
      ...
      MSG_HIGHLIGHT_LENGTH: "The number of highlighted non white space characters needs to be between 5 and 2000. Please select some text and try again.",
      MSG_HOMEPAGE_RESTRICTION: "To minimize graffiti, highlight and sticky notes are not allowed on homepages of websites. You can still use page comments however.",
      MSG_LOADING: "Loading...",
      MSG_COMMENT_CANNOT_BE_EMPTY: "Please input content.",
      MSG_NEED_TO_SIGNIN: 'Please <a target="_blank" href="https://secure.diigo.com/sign-in?f=diigolet" title="Sign in into diigo.com" onmousedown="return diigolet.handle(event, \'tb_signIn\')">sign in</a> first.',
    ...
    x.urls = {
      ...
      getGroupHome: function () {
        ...
        return diigolet.consts.DIIGO_SERVER + "/search/g?cx=!partner-pub-7625644023173335%3Agqffh9-8lvc&cof=FORID%3A11&ie=UTF-8&q=" +
          encodeURIComponent(a) + "&sa=Search#985"
    ...
    x.handlers = {
      tb_showDropDownMenu: function (a, c) {
        ...
        if ($.browser.chrome && typeof document.webkitHidden != "undefined") return false; else if ($.browser.mozilla && typeof document.mozHidden != "undefined") return false;
        a.stopPropagation();
        a.preventDefault();
        ia() ? C.signOut() :
          C.signIn();
        ...
        if ($.browser.msie && $.browser.version >= 9) {
          tbar = $("#diigolet-toolbar");
          ra(H.jHelpTip.css({top: tbar.offset().top + tbar.height() - 5}).show())
      ...
      readlater: function () {
        if (da()) if (k.bookmark.unread == true) H.notify("This page has already been put into Reading List.", 2E3); else {
        ...
        if (!k.isHighlightPen) {
          $("#diigolet-button-highlight").toggleClass(k.mouseClass,
            false);
        ...
        k.penColor && k.penColor.length > 0 ? K("diigolet-colorMenu-" + k.penColor).toggleClass("colorchecked", true) : K("diigolet-colorMenu-yellow").toggleClass("colorchecked", true);
        $.browser.msie && $.browser.version >=
        9 ? ra($("#diigolet-tb-colorMenu").css({left: a.offset().left, top: $(document).scrollTop() + 25}).show()) : ra($("#diigolet-tb-colorMenu").css({left: a.offset().left}).show())
      }, sharetoTwitter: function (a) {
        var c = k.bookmark;
        k.permalinkURL.length <= 0 && (k.pageComments.length > 0 || k.annotations.length > 0) ? C.makeAnnotatedLink(c.url, 3, function (d) {
        ...
        if (da()) {
          var a = k.bookmark;
          k.permalinkURL && k.permalinkURL.length > 0 ? window.open("http://twitter.com/share?url=" + encodeURIComponent(k.permalinkURL) + "&via=Diigo&text=" + encodeURIComponent(a.getTitle()) + "&related=diigo", "Sharer", "toolbar=0,status=0,width=580,height=320,chrome=yes,centerscreen") : window.open("http://twitter.com/share?url=" + encodeURIComponent(a.url) + "&via=Diigo&text=" + encodeURIComponent(a.getTitle()) + "&related=diigo", "Sharer", "toolbar=0,status=0,width=580,height=320,chrome=yes,centerscreen")
        }
      }, shareToFaceBook: function (a) {
        k.permalinkURL.length <=
        0 && (k.pageComments.length > 0 || k.annotations.length > 0) ? C.makeAnnotatedLink(bm.url, 3, function (c) {
        ...
        if (da()) {
          var a = k.bookmark;
          k.permalinkURL && k.permalinkURL.length > 0 ? window.open("http://www.facebook.com/sharer.php?u=" + encodeURIComponent(a.url) + "&t=" + encodeURIComponent(a.getTitle()), "sharer", "toolbar=0,status=0,width=626,height=436,chrome=yes,centerscreen") :
        ...
        C.uploadCacheCheckbf(a, 2, function (c) {
          ...
          if (c.code == 2) H.notify("Upload Succeeded", 5E3, 2); else c.code == 0 ? H.notify(c.msg && c.msg.length > 0 ? c.msg : "Your upload failed. Please try again later.",
            1E4, 3) : C.uploadIndex(a.urlId, a.batchId, function () {
        ...
        if (da()) {
          ...
          if (a.ok) {
            ...
            var f = I.add({user: k.user, realName: k.realName, content: a.html, type: diigolet.consts.ANNOTATION_TYPE_TEXT, nth: a.nth}, {}, c, d);
            console.log("user:" +
              k);
            f.type == diigolet.consts.ANNOTATION_TYPE_TEXT && chrome.runtime.sendMessage({name: "addAnnotation", annotation: f});
            $.browser.msie && document.selection.empty()
          } else a.pen ? diigolet.handle(true, "TogglePen") : H.notify(a.msg);
          window.parent && window.parent.postMessage({type: "highlight"}, "*");
          return f
        }
      }, TogglePen: function () {
        ...
        var c = $(document.body);
        c.removeClass(W(k.defaultColors, function (d) {
          return "diigoHiPen-" +
            d
        }).join(" "));
        ...
        Y.changeColor(c);
        k.isHighlightPen && $(document.body).removeClass(W(k.defaultColors, function (d) {
          return "diigoHiPen-" + d
        ...
        window.open(x.urls.getPremiumURL(),
          "_blank")
      }, addStickyNote: function () {
        !da() || B.editing || I.add({user: k.user, realName: k.realName, content: "", type: diigolet.consts.ANNOTATION_TYPE_FLOATNOTE}, {dontSave: true}).jumpHere(false, true)
    ...
    var ya = false, Ga = false, k = window.Ctx = {
      isBookmarkLoaded: false, isOwner: true, keywords: [], orphanHighlights: [], isCommented: function () {
        ...
        normal: diigoletLaunchMode ==
          0, permalink: diigoletLaunchMode == 3, pagePlayer: diigoletLaunchMode == 5, cachePage: diigoletLaunchMode == 7
      }, resetData: function () {
        M(this, {
          user: "", userId: null, realName: "", userLevel: 0, isHighlightPen: false, penColor: "yellow", mouseClass: "mouseovered", defaultColors: ["yellow", "blue", "green", "pink"], contentType: this.getMIMEType(), signedIn: false, permalinkParams: null, permalinkURL: "", files: [], silent: false, bookmark: ma.fromDocument(), groupTagsDict: {}, recommendedTagsLoaded: false, recommendedTags: [], selectionResult: null,
          annotations: [], pageComments: [], currentHighlight: "", myTags: [], myBmList: [], myContacts: [], myGroups: []
        });
        ...
        J(this.annotations, function (h) {
          ...
          $(".id_" + h.id).on("dragstart",
            function (i) {
              ...
              i.dataTransfer.setData("text/diigoHighlight",
                m);
        ...
        c = la(d);
        for (f = 0; f <= c.length; f++) if ($("." + c[f]).length == 1) $("." + c[f]).scrollmarker(); else {
          d = $("." + c[f]);
          $(d[0]).scrollmarker()
        }
    ...
    var pb = {
      lastScroll: [0, 0], start: function () {
        function a() {
          var d = ka.scrollTop(), f = ka.scrollLeft(), h = ka.width();
          $.browser.ieBelow8 ? H.j.css({top: d, left: h + f - H.ie7Width}) : H.j.css({top: d});
          h = R.j.offset();
          R.j.css({left: h.left + f - c.lastScroll[0], top: h.top + d - c.lastScroll[1]});
          var i;
          if (X.floating && (i = X.j)) i.css({left: parseInt(i.css("left")) + f - c.lastScroll[0], top: parseInt(i.css("top")) + d - c.lastScroll[1]});
          c.lastScroll[0] = f;
          c.lastScroll[1] = d
        }

        var c = this;
        ka.bind("scroll", a).bind("resize",
          a);
        a()
      }
    }, qb = {
      ...
      ele: null, shown: false, init: function () {
        ...
        if (ia()) {
          ...
          d.find("." + {
            selection: "_selection", highlight: "_highlight",
        ...
        this.ele = $(diigolet.consts.HTML_CONTEXT_MENU).css({position: "absolute"}).hide().appendTo(document.body).hide()
      }
    };
    x.run = function () {
      var a = A.dom.getDocumentSource();
      window.diigoSourceHtml = a.replace(/<script[^>]*src=[^>]*[(diigolet.js)(diigolet_b_h_)][^>]*>([\\S\\s]*?)<\/script>/g,
      ...
      C.loadBookmark();
      eb();
      !window.__diigolet_hidden && !k.launchMode.cachePage &&
      H.show();
    ...
    var $a = {
      quoteTag: function (a) {
        ...
        for (var f = [], h = [], i = false, m = 0, l =
          a.length, r; r = a.charAt(m), m < l; m++) if (r == '"') if (i) {
          i = false;
          d()
        } else i = true; else if (i) f.push(r); else /\s/.test(r) || r == "," ? d() : f.push(r);
        d();
        if (c) h = Pa(Qa(h), function (y) {
          return pa(y) || null
        });
        return h
      }, unparseTags: function (a, c) {
        c = c || " ";
        return W(a, function (d) {
    ...
    var ma = T.extend({
      constructor: function (a) {
        M(this, {
          url: "", urlId: "", b_id: "", title: "", description: "", user: "", unread: false, mode: diigolet.consts.PRIVACY_MODE_PRIVATE, tags: [], alert: false, onlyInGroup: false, groups: [],
          lists: [], datetime: null, saved: false, toAddToBookmarkLists: null, toShareToGroups: null, toShareExistingAnnotations: false
        }, a || {})
      }, getTitle: function () {
    ...
    ma.fromDocument = function () {
      var a = document;
      return k.launchMode.cachePage ? new ma({url: _DIIGO_CACHE.originUrl, title: a.title || a.location.href}) : new ma({url: a.location.href, title: a.title || a.location.href})
    };
    var I = T.extend({
      constructor: function (a) {
        a = a || {};
        M(this, {
          id: null, user: "", mode: diigolet.consts.PRIVACY_MODE_PRIVATE, content: "", comments: [], saved: false, datetime: "", painted: false, paintedSuccessfully: false, type: null,
          groups: [], onlyInGroup: false, extra: {}
        }, a);
        ...
        var a;
        a = this.type == diigolet.consts.ANNOTATION_TYPE_TEXT ? $("em." + L.HIGHLIGHT_ID_CLASS + this.id) : $("." + L.HIGHLIGHT_TYPE_CLASS + this.type + "." + L.HIGHLIGHT_ID_CLASS + this.id);
        if (a.size() <= 0) return {left: 0, top: 0};
        var c = window,
          d = {left: 0, top: 0}, f = 0, h = 0;
        ...
        if (this.paintedSuccessfully) {
          ...
          if (f.size() == 0) H.notify(diigolet.consts.MSG_HIGHLIGHT_NOT_FOUND); else {
            if (a) {
              var h = f.eq(0).offset();
            ...
            f = f.eq(f.size() - 1);
            h = f.offset();
            e = d ? {pageX: d.pageX, pageY: d.pageY + f.height()} : {pageX: h.left, pageY: h.top + f.height() + 15};
            B.hide();
    ...
    M(I, {
      add: function (a, c, d, f) {
          ...
          $("." + h).on("dragstart", function (i) {
            ...
            $("." + h).each(function () {
              if ($(this).hasClass("diigoHighlight")) {
                ...
                if ($(this).parent()[0].tagName == "A") l = '<a href="' +
                  $(this).parent().attr("href") + '"">' + l + "</a>";
                m += l + " "
              }
            });
            i.dataTransfer.setData("text/plain", m);
        ...
        a.groups && J(a.groups, function (i) {
    ...
    var ba = I.extend({
      constructor: function (a) {
        ...
        a = k.bookmark.url;
        if (!this.content) if (this._focusedNode) this.content =
          Q('<img src="#{0}" title="#{1}" alt="#{2}" />', [ba.makeAbsUrl(this._focusedNode.src, a), this._focusedNode.title, this._focusedNode.alt]); else throw"Must specify either content or _focusedNode for image highlight";
        ...
        if (!this.saved && this._focusedNode) for (var c = ba.makeRelUrl(this.extra.imageUrl, a), d = ba.makeAbsUrl(this.extra.imageUrl,
          a), f = document.getElementsByTagName("img"), h = 0, i = 0, m = f.length, l; l = f[i], i < m; i++) if (l.src.indexOf(c) > -1 && d == ba.makeAbsUrl(l.src, a)) {
          h++;
        ...
        if (a.size() == 0) for (var c = ba.makeRelUrl(this.extra.imageUrl, k.bookmark.url), d = ba.makeAbsUrl(this.extra.imageUrl, k.bookmark.url), f = document.getElementsByTagName("img"), h = 0, i = 0, m = f.length, l; l = f[i], i < m; i++) if (l.src.indexOf(c) > -1 && d == ba.makeAbsUrl(l.src, k.bookmark.url)) {
          h++;
    ...
    M(ba, {
      paint: function (a) {
        function c(i, m) {
          $(i).addClass(L.HIGHLIGHT_ICON_CLASS).addClass(L.HIGHLIGHT_ID_CLASS + m.id).addClass(L.HIGHLIGHT_TYPE_CLASS + diigolet.consts.ANNOTATION_TYPE_ICON).addClass("ImageIcon").toggleClass("public", m.isPublic() && f.length > 0).toggleClass("private", m.isPrivate() && f.length > 0).toggleClass("group", m.inAnyGroups() && f.length > 0).toggleClass("diigoHighlightcommented", f.length > 0);
          if (f.length > 0) {
            $(i).html("<span class='" + L.HIGHLIGHT_ID_CLASS +
              m.id + " " + L.HIGHLIGHT_ICON_CLASS + " " + L.HIGHLIGHT_TYPE_CLASS + diigolet.consts.ANNOTATION_TYPE_ICON + "'>" + f.length + "</span>");
        ...
        if (!(a.mode == diigolet.consts.PRIVACY_MODE_PUBLIC && a.groups.length <= 0)) {
          ...
          if (d) {
            var f = a.comments;
            d.addClass(S.HIGHLIGHT_CLASS).addClass(S.HIGHLIGHT_ID_CLASS + a.id).addClass(S.HIGHLIGHT_TYPE_CLASS + a.type).removeClass("yellow blue green pink").addClass(a.extra.color &&
            a.extra.color.length > 0 ? a.extra.color : "yellow").toggleClass("diigoHighlightcommented", f.length > 0);
            if (d.size() > 0) {
              var h = d.offset();
              a.extra.top = h.top;
              a.extra.left = h.left
        ...
        a = I.find(a);
        var c = a.getEle();
        c && c.removeClass(S.HIGHLIGHT_ID_CLASS +
          a.id).removeClass(S.HIGHLIGHT_CLASS).removeClass("diigoHighlightcommented").removeClass("public").removeClass("group")
      ...
      paint: function (a) {
        ...
        if (a.painted) {
          ...
          if (c) {
            ...
            setTimeout(function () {
              (B.getCommentCount("group", a.comments) ||
                "") > 0 && c.find("span").text(B.getCommentCount("group", a.comments)).show()
            }, 100)
          }
        } else {
          c = $(diigolet.consts.HTML_FLOAT_NOTE).addClass(S.HIGHLIGHT_CLASS).addClass(S.HIGHLIGHT_ID_CLASS + a.id).addClass(S.HIGHLIGHT_TYPE_CLASS + a.type).css({left: a.extra.left, top: a.extra.top}).appendTo(document.body);
          ...
          B.getCommentCount("group",
            a.comments) == 0 && c.find("span").hide();
    ...
    var Ca = T.extend({
      constructor: function (a) {
        M(this, {
          id: null, user: "", mode: diigolet.consts.PRIVACY_MODE_PRIVATE, saved: false, datetime: "", groups: [],
          onlyInGroup: false
        }, a || {});
    ...
    M(ea, {
      add: function (a) {
        ...
        if (a.onlyInGroup && a.groups.length == 0) {
          ...
          if (h.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && d.length == 0) var i = function () {
            h.del(c)
          }
        }
        return a
    ...
    J([ma, I, Ca], function (a) {
      a.implement({
        isPublic: function () {
          ...
          return c == "_all" ? this.isPublic() || this.isPrivate() || this.inAnyGroups() :
            c == "_smasher" ? this.isPublic() || this.isPrivate() : c == "_public" ? this.isPublic() : c == "_private" ? this.isPrivate() : this.inGroup(c)
        }
      })
    });
    var C = {
      transId: 0, callbacks: {}, getScriptId: function (a) {
        return "diigoletScriptCall_" + a
      }, callback: function (a) {
        var c = a.transId, d = a.cmd;
        ...
        } else k.signedIn && !a.user &&
        !a.batch_id && !k.launchMode.cachePage && Ya();
        if (d) {
      ...
      invoke: function (a, c, d) {
        ...
        d = {cmd: a, v: 13, _nocache: Math.random(), json: $.toJSON(c), user: k.user, transId: f};
        N("[WebAPI request]", a, c);
        if (a == "user_signIn") c = Q(diigolet.consts.DIIGO_DATA_SERVER + "/chappai/pv=#{pv}/ct=tb/cv=#{cv}/cmd=#{cmd}", {pv: 13, cv: x.version, cmd: a}); else {
          if (k.user == "") k.user = _DIIGO_CACHE.originUser;
          c = Q(diigolet.consts.DIIGO_DATA_SERVER + "/chappai/pv=#{pv}/ct=tb/cv=#{cv}/user=#{user}/cmd=#{cmd}/", {
            pv: 13,
            cv: x.version, user: k.user, cmd: a
          })
        }
        ...
        var h = this;
        h.xhr = $.ajax({
          type: "POST", url: a, data: c, complete: function (i) {
            try {
      ...
      invokeUpload: function (a, c) {
        ...
        if (d.length > ($.browser.msie ? 2E3 : 4E3)) H.notify("Too many words you inputted."); else {
          f.src = a;
        ...
        var h = "<iframe frameborder='0' scrolling='no' id='diigo_upload_iframe_" +
          f + "' style='width: 400px; height: 30px; margin: 0; padding: 0;' src='#' width='400px' height='30px'></iframe>", i = document.createElement("div");
        i.id = "diigotlet_upload";
        i.setAttribute("style", "position: fixed; height:30px; width: 400px; top: 33px; left: " + H.j.offset().left + (H.ie7Width - 400) / 2 + "px; z-index: 10000000; margin: 0; padding: 0;display:none;");
        i.innerHTML = h;
        $("body").append(i);
        ...
        b = atob(f);
        c = {
          type: c, title: a.title, description: "", mode: a.mode, src_url: _DIIGO_CACHE.originUrl, src_title: a.src_title,
          src_description: "", src_unread: false, file_type: i, file_name: m, single_item: a.single_item, file_md5: qa(b), shareit: false, twitterit: d, tags: a.tags, extra: h
        };
        console.log(c);
        N(a.list, a.groups);
        ...
        chrome.extension.getBackgroundPage().Messenger.handlers.WebAPI({details: a}, {}, void 0)
      }, loadBookmark: function () {
        var a = {
          url: k.bookmark.url, what: "bookmarkInfo annotations pageComments",
          permalinkParams: null
        };
        if (_DIIGO_CACHE.cachePermalinkKey) a.permalinkParams = {user: _DIIGO_CACHE.originUser, key: _DIIGO_CACHE.cachePermalinkKey, "for": "cache"};
        ...
        if (a.annotations) {
          ...
          J(a.annotations, function (d) {
            var f = I.add(ga({saved: true}, d, ca("id user realName mode type content datetime extra groups onlyInGroup")), {dontPaint: true, dontSort: true});
        ...
        if (!k.launchMode.cachePage) if (!c.saved) {
          k.bookmark =
            ma.fromDocument();
          C.saveBookmark(null, function () {
          })
        ...
        var d = k.bookmark, f = {url: d.url, mode: d.mode, title: d.title, tags: d.tags, description: d.description, unread: d.unread};
        ...
        if (a) {
          if (h = a.pageComment) {
            ...
            if (h.groups) {
              ...
              f.pageComment.justForGroups =
                h.justForGroups;
              f.groups = h.groups
            }
          }
          if (h = a.annotation) {
            f.annotation = {id: h.id, content: h.content, type: h.type, extra: h.extra};
            if (h.groups) {
              f.annotation.groups = h.groups;
              f.groups = h.groups
            }
            if (h = a.annotation.inlineComment) {
              f.annotation.inlineComment = {mode: h.mode, content: h.content};
              if (h.groups) {
        ...
        if (c = a.pageComment) ja.add({id: c.id, user: c.user, realName: c.realName, mode: c.mode, datetime: c.datetime, content: c.content, userOnline: c.userOnline, groups: c.groups, onlyInGroup: c.onlyInGroup, saved: true});
        if (c = a.annotation) {
          var d = I.find(c.id);
          c.groups && d.addGroups(c.groups);
          if (c = a.annotation.inlineComment) ea.add({
            id: c.id,
            annotationId: c.annotationId, user: c.user, realName: c.realName, mode: c.mode, datetime: c.datetime, content: c.content, userOnline: c.userOnline, groups: c.groups, onlyInGroup: c.onlyInGroup, saved: true
          })
        }
        if (a = a.result_shareExisting) {
          ...
          J(a.annotations, function (f) {
            ...
            if (h) {
              ...
              f.inlineComments && J(f.inlineComments, function (i) {
                var m = ea.find(i.id);
        ...
        k.pageComments.filter(function (c) {
          return c.user == k.user && !c.onlyInGroup
        }).forEach(function (c) {
          c.saved = false;
          ja.del(c)
        });
        k.annotations.filter(function (c) {
          return c.user == k.user && !c.onlyInGroup
        }).forEach(function (c) {
          c.saved = false;
          c.del()
        ...
        var c = {urlId: k.bookmark.urlId, id: a.id, content: a.content, type: a.type, extra: a.extra, groups: a.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE ? null : k.bookmark.getGroupNamesSharedByMe()};
        if (a._toAddInlineComment) {
          c.inlineComment = a._toAddInlineComment;
          delete a._toAddInlineComment
        }
        k.bookmark.saved ? this.invoke("annotation_add",
          c) : this.saveBookmark({annotation: c})
        ...
        k.bookmark.saved ? this.invoke("pc_add", a) : this.saveBookmark({pageComment: a})
      }, makeAnnotatedLink: function (a, c, d) {
        this.invoke("share_makeAnnotatedLink", {url: a, mode: c}, d)
      }, cb_pc_add_success: function (a) {
        ja.add({id: a.id, user: a.user, realName: a.realName, mode: a.mode, datetime: a.datetime, content: a.content, userOnline: a.userOnline, groups: a.groups, onlyInGroup: a.onlyInGroup, saved: true});
        (a =
          a.__bookmark_groups) && k.bookmark.addGroups(a)
        ...
        ea.add({
          id: a.id, annotationId: a.annotationId, user: a.user, realName: a.realName,
          mode: a.mode, datetime: a.datetime, datetime2: a.datetime2, content: a.content, userOnline: a.userOnline, groups: a.groups, onlyInGroup: a.onlyInGroup, saved: true
        });
        ...
        this.invoke("user_loadMyStuff", {what: "myTags myGroups myProfile myBookmarkLists permissions myContacts"})
        ...
        this.invoke("annotation_updateExtra", {
          urlId: k.bookmark.urlId, id: a.id, idsInGroup: W(Da(a.groups, function (c) {
        ...
        a = {ct: "let", user_name: k.user, link_id: a.urlId, upload_type: c, type: k.contentType, groups: a.toShareToGroups == null ? [] : a.toShareToGroups, md5: qa(window.diigoSourceHtml)};
        posturl = x.urls.getUploadMD5Check() + x.utils.string.toQueryString(a) + "&transId=";
        this.invokeUpload(posturl,
          d)
      }, uploadIndex: function (a, c, d) {
        a = {ct: "let", user_name: k.user, link_id: a, batch_id: c, upload_type: [2, 3]};
        ...
        this.invokePost(posturl, {htmlType: k.contentType, htmlBase64Md5: qa(a), htmlBase64Source: a, htmlCharset: document.characterSet, textType: "text/plain", textBase64Md5: qa(c), textBase64Source: c, textCharset: "utf-8"}, d)
      }, signIn: function () {
        ...
        if (a.signedIn) {
          ...
          typeof document.addEventListener === "undefined" || typeof c === "undefined" || document.removeEventListener(d,
            Va, false);
          C.loadBookmark()
        }
      }, signOut: function () {
      ...
      shown: false, ie7Width: 0, j: null, init: function () {
        var a = this;
        a.create();
        a.j.find("a.diigoletButton,#diigolet-tb-btnHide").bind("focus",
          function () {
            this.blur()
          });
        ...
        a.j.find(".diigoletButton,._hoverAndHideDropdown").bind("mouseover", function () {
          a.jHelpTip.hide();
          var c = $(this).attr("id");
          c == "diigolet-button-highlight" || c == "diigolet-button-highlight-dropdown" || c == "diigolet-tb-btnShare" || $(this).is(".hover") || a.j.find(".dropdownMenu").hide()
        })
      }, destroy: function () {
      }, onSignIn: function () {
        this.updateUI()
      ...
      hide: function () {
        ...
        if (ia()) {
          ...
          this.showInfo('<em><a target="_blank" href="' + diigolet.consts.DIIGO_UPLOAD_SERVER + '/sign-in?f=diigolet" title="Sign in into diigo.com" onmousedown="return diigolet.handle(event, \'tb_signIn\')">Sign In</a> / <a href="' +
            diigolet.consts.DIIGO_SERVER + '/sign-up" title="Create a Diigo account" target="_blank">Create a Diigo account now</a> (free!)</em>', true);
        ...
        if (k.permissions && k.permissions.premium) {
          ...
          if (!$.browser.supportPositionFixed && $.browser.ieBelow8) {
            this.ie7Width += 100;
            var a = ka.scrollTop(), c = ka.scrollLeft(), d = ka.width();
            this.j.css({top: a, left: d + c - this.ie7Width})
          }
        } else $("#diigolet-tb-btnGoPremium").hide()
      }, create: function () {
        var a = Q(diigolet.consts.HTML_TOOLBAR, {DIIGOLET_VERSION: x.version, URL_DIIGO: diigolet.consts.DIIGO_SERVER});
        try {
        ...
        $("._diigomenu").click(function (f) {
          ...
          if (className.indexOf("URL_MY_LIBRARY") >= 0) h = x.urls.getUserBookmarksPageURL(); else if (className.indexOf("URL_MY_LIST") >= 0) h = x.urls.getListHome(); else if (className.indexOf("URL_MY_GROUP") >= 0) h = x.urls.getGroupHome(); else if (className.indexOf("URL_NETWORK") >= 0) h = x.urls.getNetwork(); else if (className.indexOf("URL_HOT_BOOKMARK") >=
            0) h = x.urls.getHotBookmark(); else if (className.indexOf("URL_SIGNOUT") >= 0) {
            h = x.urls.getSignout();
        ...
        $(diigolet.consts.ID_NOTIFY).find(".diigotb-notice-close").click(function () {
          $(diigolet.consts.ID_NOTIFY).hide()
        });
        if (k.launchMode.cachePage) {
          ...
          $("#diigolet-tb-btnHide").css("background", 'transparent url("https://www.diigo.com/javascripts/webtoolbar/images/diigoletIconv3.gif") no-repeat left -244px');
        ...
        if (k.launchMode.permalink) {
          ...
          $("a._forwardUserUrl", c).attr({href: a ? diigolet.consts.DIIGO_SERVER + "/user/" + a : diigolet.consts.DIIGO_SERVER}).text(a || "Diigo");
          $("a._myBookmarks, a._info", c).hide()
        } else k.launchMode.sandbox && $("a._myBookmarks, a._info", c).hide();
        if ($.browser.ieBelow8) {
          c = $("#diigolet-tb-btnHide").width() +
            20;
          c += ia() ? 389 : 400;
          this.ie7Width = c + 15
        } else this.ie7Width = this.j.width();
        if (!ia() && $.browser.chrome && typeof document.webkitHidden != "undefined") Wa(); else !ia() && $.browser.mozilla && typeof document.mozHidden != "undefined" && Wa()
        ...
        f.css({left: a - 20});
        if (d == 2) f.addClass("process"); else d == 3 ? f.addClass("failed") : f.addClass("info");
      ...
      shown: false, j: null, init: function () {
        ...
        if (!this.shown) {
          ...
          Prefs.get("prefs.lastUsedColor", function (d) {
            ...
            k.isHighlightPen && $(document.body).removeClass(W(k.defaultColors, function (f) {
              return "diigoHiPen-" + f
            }).join(" ")).addClass("diigoHiPen-" + k.penColor)
          });
        ...
        if (this.shown) {
          ...
          $(document.body).removeClass(W(k.defaultColors, function (a) {
            return "diigoHiPen-" + a
          }).join(" "));
        ...
        k.bookmark.saved && a.attr("title",
          "Saved. Click to reorganize")
        ...
        $("#diigolet-panel-closeBtn").click(function () {
          ...
          k.toggleSilent(true);
          k.isHighlightPen = false;
          $(document.body).removeClass(W(k.defaultColors, function (c) {
            return "diigoHiPen-" + c
          }).join(" "));
          H.onHighlightPenModeChanged(false);
          U.onHighlightPenModeChanged(false);
        ...
        $("#diigolet-panel-colorPicker li").click(function (c) {
          ...
          window.getSelection().toString().length !== 0 ? x.handle(c, "highlight",
            "normal", d) : x.handle(c, "ChangeColor", d);
          c.preventDefault()
        });
        ...
        $("#diigolet-panel-feedback").click(function () {
          var c =
            $(".optList", this).toggleClass("dropdownShown"), d = function () {
            c.removeClass("dropdownShown").unbind("mouseleave", d);
            $(document.body).unbind("click", d)
          };
          c.hasClass("dropdownShown") ? setTimeout(function () {
        ...
        k.isHighlightPen = false;
        $(document.body).removeClass(W(k.defaultColors, function (h) {
          return "diigoHiPen-" + h
        }).join(" "));
        U.onHighlightPenModeChanged(false);
        return false
    ...
    var S, L, Ba = S = L = {
      ...
      HIGHLIGHT_ICON_CLASS: "diigoIcon", HIGHLIGHT_ID_CLASS: "id_", HIGHLIGHT_TYPE_CLASS: "type_", colorPen: ["yellow", "blue", "green", "pink"], isHighlightElement: function (a) {
        if (a.nodeType == 1 && a.className && typeof a.className == "string" && (a.className.indexOf(this.HIGHLIGHT_CLASS) > -1 || a.className.indexOf(this.HIGHLIGHT_ICON_CLASS) > -1)) {
          var c = {type: -1, ids: []};
        ...
        (new aa(document.body, function (c) {
          if (c.nodeType == 3) {
        ...
        return a.nodeType == 3 || a.nodeType == 1 &&
          L.tagBlackList.indexOf("," + a.tagName.toLowerCase() + ",") == -1
        ...
        if (l && r) {
          ...
          for (f = l; f = f.parentNode;) if (h(r, f)) {
            w = f;
            break
          }
          if (!w) return null
        ...
        return l &&
        r ? {startNode: l, endNode: r, startOffset: y, endOffset: z, endIndex: i, commonAncestor: w, txt: d} : null
      }, paint: function (a) {
        function c(s, u) {
          $(s).addClass(L.HIGHLIGHT_CLASS).addClass(m).addClass(L.HIGHLIGHT_TYPE_CLASS + u.type).removeClass("yellow blue green pink").addClass(u.extra.color && u.extra.color.length > 0 ? u.extra.color : "yellow").attr("draggable", "true");
          return s
        }
        ...
        function f(s, u) {
          $(s).addClass(L.HIGHLIGHT_ICON_CLASS).addClass(m).addClass(L.HIGHLIGHT_TYPE_CLASS +
            diigolet.consts.ANNOTATION_TYPE_ICON).addClass("TextIcon").toggleClass("public", u.isPublic() && l.length > 0).toggleClass("private", u.isPrivate() && l.length > 0).toggleClass("group", u.inAnyGroups() && l.length > 0 && (B.getCommentsInfo(u.comments) == "onlyGroup" || B.getCommentsInfo(u.comments) == "both")).toggleClass("diigoHighlightcommented", l.length > 0).removeClass("diigoadd yellow blue green pink").addClass(u.extra.color).css({bottom: "0px"});
          if (l.length > 0) {
            $(s).html("<span class='" + m + " " + L.HIGHLIGHT_ICON_CLASS + " " +
              L.HIGHLIGHT_TYPE_CLASS + diigolet.consts.ANNOTATION_TYPE_ICON + "'>" + l.length + "</span>");
        ...
        var h = this, i = I.find(a), m = L.HIGHLIGHT_ID_CLASS + i.id, l = i.comments;
        if (i.paintedSuccessfully) {
          c("em." + m, i);
          f("div." + m, i);
          $("em." + m).filter(":last").toggleClass("diigoHighlightcommented", l.length > 0)
        } else {
          i.painted = true;
          this.domSnapshot();
          ...
          if (r) {
            ...
            if (r.startNode === r.endNode) {
              ...
              var y = r.startNode.splitText(r.startOffset), z = r.endNode.splitText(r.endOffset).previousSibling, w = false, o = [], p = 0, n = i.prettyTxt.replace(/\s/g, "").length;
              (new aa(r.commonAncestor, function (s) {
                if (!w && s === y) w = true;
                if (w) if (h.isTextNode(s)) {
        ...
        var c = window, d;
        try {
          $("em." + L.HIGHLIGHT_ID_CLASS + a.id).parents().filter(function () {
        ...
        $("div.diigoIcon.diigoHighlightcommented.private." + L.HIGHLIGHT_ID_CLASS + a.id).attr("style", "background-color:" +
          d + " !important")
        ...
        $("em." + L.HIGHLIGHT_ID_CLASS + a.id).each(function (d, f) {
          var h = $(f), i = Ta(h.css("backgroundColor")), m = Ta(h.css("color"));
          var l = c(m), r = c(i);
          if (l > r) {
            m = l;
            l = r
        ...
        return window.getSelection ? pa(String(window.getSelection())).length > 0 : $.browser.msie ? document.selection.type == "Text" && pa(document.selection.createRange().text).length > 0 : false
      }, getSelection: function () {
        var a =
          "";
        if (window.getSelection) a = pa(String(window.getSelection())); else if ($.browser.msie) a = document.selection.type == "Text" && pa(document.selection.createRange().text);
        return a
      }, checkSelection: function () {
        var a, c = {ok: false, txt: "", html: "", msg: "", pen: false}, d = null;
        ...
        if (window.getSelection) {
          ...
          $.browser.msie ? this.range2html(document.selection.createRange()) : document.getSelection();
        ...
        if (d) {
          var f = this, h = "";
          a = 0;
          (new aa(document.body, function (m) {
            if (m.nodeType ==
              3) {
    ...
    aa.prototype._walk = function (a, c) {
      ...
      if (!this.end) if (d.filter(a)) {
        ...
        for (a =
               d.reverse ? a.lastChild : a.firstChild; a;) {
          this._walk(a, c);
    ...
    var B = {
      j: null, shown: false, showMode: "view", dragging: false, backupContent: "", editInterval: null, tempObj: {}, saveInterval: null, privateEditing: false, filterMode: "_all", ann: null, init: function () {
        if ($("#diigolet-dlg-sticky").length === 0) {
          ...
          setTimeout(function () {
            a.j.bind("mouseleave", function () {
              ...
              a.dragging || k.draggingFloatNote ||
              a.cancelHide()
            })
          }, 13);
          ...
          $(".FN-switcher").on("click", function (c) {
            if (c.target.id == "FN-switcher-private" || c.target.parentNode.id == "FN-switcher-private") a.switchTab("private"); else if (c.target.id == "FN-switcher-group" ||
              c.target.parentNode.id == "FN-switcher-group") a.switchTab("group")
          });
          $("#diigolet-dlg-sticky-addTab").on("click", function () {
            if (!($("#FN-group-content-postform").find("button").prop("disabled") == true || $("#FN-group-post").prop("disabled") == true)) if (a.j.hasClass("onlyPrivate")) {
          ...
          $("#FN-group-menu").on("click", "li", function (c) {
            if (c.target.id ==
              ...
              d.append(A.dom.buildOne("option", {value: 0}, ["Choose a group"]));
              d.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
              J(k.myGroups, function (f) {
                $("#FN-group-ul").find('li[data-dgroupname="' + f.name + '"]').length == 0 && d.append(A.dom.buildOne("option", {value: f.name}, [f.displayName]))
              });
              $("#FN-current-group").find("span").text("+Share to a new group");
              $("#FN-group-post").focus()
            } else {
          ...
          $("#FN-post-form").find("a").on("click", function () {
          ...
          $("#FN-private-editor").on("input propertychange",
            function () {
      ...
      destroy: function () {
        ...
        this.j = $(diigolet.consts.HTML_DLG_IC).css({position: "absolute"}).appendTo(fa.body).hide();
        ...
        if (c == "click") {
          if (!this.ann.extra || this.ann.extra == "undefined") this.ann.extra = {color: a}; else this.ann.extra.color =
            a;
          ...
          chrome.runtime.sendMessage({name: "editItem", cmd: "changeColor", annotation: this.ann})
        }
        ...
        setTimeout(function () {
          ...
          y.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
          J(k.myGroups, function (z) {
            $("#FN-group-ul").find('li[data-dgroupname="' + z.name + '"]').length == 0 && y.append(A.dom.buildOne("option", {value: z.name}, [z.displayName]))
          });
          i.j.hasClass("onlyPrivate") ?
            $("#diigolet-dlg-sticky-addTab").attr("title", "Add a group note") : $("#diigolet-dlg-sticky-addTab").attr("title", "Add a private note")
        }, h)
      }, mergePrivateComments: function (a) {
        for (var c = this.ann, d = c.comments.length, f = [], h = 0; h < d; h++) c.comments[h].mode === diigolet.consts.PRIVACY_MODE_PRIVATE && f.push(c.comments[h].id);
        a = {annotationId: c.id, mode: 2, content: a};
        if (c.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE && !c.saved) {
          c._toAddInlineComment = a;
          c.saving = true;
          C.addAnnotation(c)
        } else if (c.type == diigolet.consts.ANNOTATION_TYPE_TEXT &&
          !c.saved) {
          c._toAddInlineComment = a;
          c.saving = true;
          C.addAnnotation(c)
        ...
        setTimeout(function () {
          for (var i = 0; i < f.length; i++) {
            var m = ea.find(f[i]), l = m.getAnnotation();
            l.comments.splice(l.comments.indexOf(m), 1);
            C.deleteInlineComment(m)
          }
        }, 200)
      }, shareToNewGroup: function () {
        var a = $("#FN-post-form"), c = a.find("textarea"), d = c.val(), f = a.find("select"), h = f.val();
        if (d.match(/^\s*$/)) {
          c.addClass("notify");
          setTimeout(function () {
            c.removeClass("notify")
          ...
          a.find("textarea").prop("disabled",
            true)
        }
      }, addPrivateComment: function () {
        var a = $("#FN-private-editor").val();
        if (!a.match(/^\s*$/)) {
          a = {annotationId: B.ann.id, mode: diigolet.consts.PRIVACY_MODE_PRIVATE, content: a};
      ...
      hide: function () {
        ...
        var a = this.j.find("div.IconFeild").offset(), c = K("diigolet-annMenu");
        ...
        if (d.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE) {
          ...
          d.extra && d.extra.color && d.extra.color.length > 0 ? K("diigolet-context-" + d.extra.color).toggleClass("colorchecked", true) : K("diigolet-context-yellow").toggleClass("colorchecked", true)
        }
        c.find("#diigolet-annMenu-tip-before").hide();
        c.css({top: a.top + 20, left: a.left});
        ra(c.show(), 13)
      }, uploadPrivateComment: function () {
        var a = $("#FN-private-editor").val(), c = $("#FN-private-delete").attr("data-cid");
        ...
        this.ann.getComments(this.filterMode).length ==
        0 && this.j.find("div.diigoletFNContent").html('<span class="noComments">There are no sticky notes yet.</span>')
        ...
        var h = $(document).scrollTop(),
          i = c + $(window).width() - d.width() - 10, m = h + $(window).height() - d.height() - 10;
        if (f > i) f = i;
        if (f < c) f = c;
        if (a > m) a = m;
        if (a < h) a = h;
    ...
    M(B, {
      eleId_ic: function (a) {
        ...
        if (a.isPublic() && (c == "_all" || c == "_public") && a.user == k.user) d += '<label class="_public"><span>Public</span>DEL</label>'.replace("DEL", ua(f, {ONCLICK: "diigolet.handle(event, 'dlgIC_del_ic', '" + a.id + "')"}));
        if (a.isPrivate() && (c == "_all" || c == "_private")) d += '<label class="_private"><span>Private</span>DEL</label>'.replace("DEL", ua(f, {ONCLICK: "diigolet.handle(event, 'dlgIC_del_ic', '" + a.id + "')"}));
        J(a.groups, function (h) {
          if (c == h.name || c == "_all") d += ua('<label class="_#{GROUP_NAME}"><a href="#{GROUP_URL}" class="link">#{GROUP_DISPLAY_NAME}</a>#{DEL}</label>',
            {GROUP_NAME: h.name, GROUP_DISPLAY_NAME: h.displayName, GROUP_URL: x.urls.getGroupURL(h.name), DEL: ua(f, {ONCLICK: "diigolet.handle(event, 'dlgIC_del_ic', '" + a.id + "', '" + h.name + "')"})})
        });
        return d
      }, addInlineComment: function (a) {
        if (a.mode == diigolet.consts.PRIVACY_MODE_PRIVATE) {
          ...
          if (this.j.hasClass("groupNew")) {
            ...
            $("#FN-group-content-container")[0].scrollTop =
              $("#FN-group-content-container")[0].scrollHeight;
        ...
        for (h = 0; h < f; h++) if (a[h].mode == diigolet.consts.PRIVACY_MODE_PRIVATE) c++; else a[h].mode == diigolet.consts.PRIVACY_MODE_GROUP && d++;
        return c == 0 && d == 0 ? "noComment" :
          c > 0 && d == 0 ? "onlyPrivate" : c == 0 && d > 0 ? "onlyGroup" : "both"
        ...
        var c = a.length, d = "", f = "", h, i = this.getCommentCount("private", a), m;
        if (i >= 1) for (m = 0; m < c; m++) {
        ...
        return ua('<div class="FN-group-comment-item" data-cid="#{ID}"><div class="FN-group-comment-item-tbar"><a href="#" class="FN-group-comment-name">#{USERNAME}</a><span class="FN-group-comment-item-time">#{DATETIME}</span>#{DELETE}</div><div class="FN-group-comment-item-content">#{CONTENT}</div></div>',
          {ID: a.id, USERNAME: a.realName, CONTENT: a.content, DATETIME: a.datetime, DELETE: k.user == a.user ? '<a class="FN-group-comment-item-delete">delete</a>' : ""})
      }, getGroups: function (a) {
        for (var c = [], d = 0; d < a.length; d++) if (a[d].mode == diigolet.consts.PRIVACY_MODE_GROUP) for (var f = 0; f < a[d].groups.length; f++) {
          var h = {};
        ...
        if (a === "private") var i = diigolet.consts.PRIVACY_MODE_PRIVATE; else if (a === "group") i = diigolet.consts.PRIVACY_MODE_GROUP;
        ...
        $('.FN-group-comment-item[data-cid="' +
          a.id + '"]').remove();
        if ($('.FN-group-content-section[data-dgroup="' + c + '"]').find(".FN-group-comment-item").length == 0) {
          ...
          $("#FN-group-ul").find('li[data-dgroupname="' + c + '"]').remove()
        }
        if ($("#FN-group-content-container").find(".FN-group-content-section").length == 0) {
        ...
        chrome.runtime.sendMessage({name: "editItem", cmd: "addInlineComment", annotation: {id: a.id, content: a.content, annotationId: a.annotationId}})
      }, onic_del: function (a, c) {
        this.removeInlineComment(a, c);
        chrome.runtime.sendMessage({name: "editItem", cmd: "delInlineComment", annotation: {id: a.id, content: a.content, annotationId: a.annotationId}})
        ...
        chrome.runtime.sendMessage({name: "editItem", cmd: "updateStickyNote", annotation: {id: a.id, content: a.content, annotationId: a.annotationId}})
      }
    });
    M(B, {
      NO_PUBLIC_STICKY_NOTES_ALLOWED: true, isEditing: function () {
        ...
        jEdit: null, init: function () {
          ...
          var a = $(".diigoletFNPriSlct").empty(), c = B.ann, d = B.filterMode;
          if ((d == "_all" || d == "_public") && (c ? true : true) && (c ? !c.onlyInGroup && c.getComments("_private").length == 0 : true)) B.NO_PUBLIC_STICKY_NOTES_ALLOWED || a.append('<option value="_public">Public</option>');
          if ((d == "_all" || d == "_private") &&
            (c ? !c.onlyInGroup && c.getComments("_public").length == 0 : true)) a.append('<option value="_private">Private</option>');
          J(k.myGroups, function (h) {
            if ((d == "_all" || d == h.name) && (c && (c.user != k.user || c.onlyInGroup) ? c.inGroup(h.name) : true)) a.append(A.dom.buildOne("option", {value: h.name}, [h.displayName]))
          });
          d == "_all" && c && c.isPrivate() && a.val("_private");
          if (a.find("option").length == 0) B.j.find(".diigoletFNComment").hide(); else {
    ...
    var R = {
      tagListNames: "recent recommend group".split(" "), shown: false, ele: null, init: function () {
        this.create()
      }, destroy: function () {
      }, show: function (a, c) {
        if (!(!ia() || this.shown && this.j.is(":visible"))) {
          ...
          a &&
          c ? this.syncData("saveLink", true, a, c) : this.syncData("data->form", true);
          d.refreshPremium();
          ...
          /https:\/\/www.hnsearch.com\/search/.test(window.location.href) && $("#Diigo-Bookmark-Url,#Diigo-Bookmark-Title,#Diigo-Bookmark-Description,#Diigo-Bookmark-Tag").bind("focus", function () {
            ...
            $(window).bind("keypress", function (m) {
              m.preventDefault();
              var l = $(i).val();
              $(i).focus().val(l + String.fromCharCode(m.charCode))
            })
          })
        }
        ...
        if (c) if (c.length == 0) f.hide(); else {
          ...
          f.find(".tagButton").remove();
          J(c, function (m) {
            var l = $(A.dom.buildOne("div", {id: "diigolet-tag-" + a + "-" + d.escapeTagForElementId(m), "class": "tagButton", tag: m}, [m])).appendTo(f.show());
        ...
        var d = $("#Diigo-Bookmark-Tag-Input"),
          f = x.parseTags(d.val(), true), h = $.inArray(a, f);
        ...
        if (d != -1) c = d;
        c ? C.loadGroupTagsDictionary([c], function () {
        ...
        $(c._tagContainerIdForTagListName(a)).find(".tagButton").each(function () {
          c.toggleTag($(this).addClass("selected").text(),
            true)
        })
        ...
        var a = this;
        a.j = (new db(diigolet.consts.HTML_DLG_BOOKMARK)).css({position: $.browser.supportPositionFixed ? "fixed" : "absolute"}).hide().appendTo(fa.body).hide();
        ...
        $("#diigolet-dlgBm-btnSaveandmore").click(function (d) {
          x.handle(d,
            "bmOnSubmitAndClose", "bookmark");
          d = encodeURIComponent($("#Diigo-Bookmark-Title").val());
          var f = encodeURIComponent($("#Diigo-Bookmark-Url").val()), h = encodeURIComponent($("#Diigo-Bookmark-Tag").val());
        ...
        $("#Diigo-Bookmark-Title-Input,#Diigo-Bookmark-Description-Input,#Diigo-Bookmark-Tag-Input").on("focus",
          function () {
        ...
        $("#diigo-list-addBtn").on("click", function () {
          if (!$(this).hasClass("processing")) {
            var d = $("#diigo-list-addInput").val(), f = $("#diigo-list-add .diigo-alert-tip"), h = [], i = k.myBmLists.length, m;
            for (m = 0; m < i; m++) h.push(k.myBmLists[m].title);
            if (d.match(/^\s*$/)) f.show().find("span").text("Input a name"); else if ($.inArray(d, h) !== -1) f.show().find("span").text("Name existed !"); else {
        ...
        if (a == "data->form") {
          ...
          if (ha(a.val())) if (ha(i.description)) ha(c) || a.val('"' + c + '"'); else a.val(i.description); else {
            a.val("");
            i.saved && !ha(i.description) &&
            a.val(i.description)
          }
          h.updateGroups();
          h.updateLists();
          i.saved == false ? chrome.storage.local.get(null, function (m) {
          ...
          i.tags = x.parseTags($("#Diigo-Bookmark-Tag-Input").val(),
            true);
          i.mode = $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").hasClass("checked") ? diigolet.consts.PRIVACY_MODE_PRIVATE : diigolet.consts.PRIVACY_MODE_PUBLIC;
          ...
          x.Messenger.send({name: "initialData"}, function (m) {
            m.preloadedPrefs["prefs.bookmark.privateByDefault"] == "true" ? $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").addClass("checked") :
        ...
        j.append(A.dom.buildOne("option",
          {value: 0}, ["Add to an Outliner"]));
        j.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
        $(A.dom.buildOne("option", {value: -2}, ["Create an Outliner..."])).appendTo(j);
        j.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
        J(k.outliners, function (c) {
          a ? j.append(A.dom.buildOne("option", {value: c.id}, [c.title])) : j.append(A.dom.buildOne("option", {value: c.id}, [c.title + (k.bookmark.inList(c.id) ? " (added)" : "")]))
        });
        j.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
        if (k.myBmLists.length) {
          j.append(A.dom.buildOne("option", {value: -8}, ["Add to a List"]));
          j.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
        ...
        var c = this, d = $("#diigo-group").find("select").empty().unbind().removeClass("processing");
        d.append(A.dom.buildOne("option", {value: 0}, ["Share to a group"]));
        d.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
        $(A.dom.buildOne("option", {value: -2}, ["Create a Group..."])).appendTo(d);
        d.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
        J(k.myGroups, function (f) {
          a ? d.append(A.dom.buildOne("option", {value: f.name}, [f.displayName])) : d.append(A.dom.buildOne("option", {value: f.name}, [f.displayName + (k.bookmark.inGroup(f.name) ? " (shared)" : "")]))
        });
        d.append(A.dom.buildOne("option", {value: -1}, [Array(20).join("-")]));
        $(A.dom.buildOne("option",
          {value: -3}, ["Refresh"])).appendTo(d);
        d.change(function () {
          var f = d.val();
          if (f == -2) {
        ...
        K("Diigo-Bookmark-checkShareExisting").showHide(a &&
          k.isAnnotated())
      }, submitAndClose: function () {
        var a = true, c = "", d = $("#Diigo-Bookmark-Url-Input").val();
        ...
        if (c) {
          ...
          a.mode = $("#Diigo-Bookmark-Privacy").find(".op-checkbox-container").hasClass("checked") ? diigolet.consts.PRIVACY_MODE_PRIVATE : diigolet.consts.PRIVACY_MODE_PUBLIC;
      ...
      j: null, floating: false, container: null, init: function () {
        ...
        k.addEventListener("ann_add",
          this);
        k.addEventListener("ann_del", this)
      }, destroy: function () {
      }, create: function () {
        var a = Q(diigolet.consts.HTML_SIDEBAR, {URL_DIIGO: diigolet.consts.DIIGO_SERVER});
      ...
      onSignOut: function () {
        ...
        var d = $({inline: "#d3df-togglePanelInline", page: "#d3df-togglePanelPage"}[a]), f = $({inline: "#d3df-inlineCommentBox", page: "#d3df-pageCommentBox"}[a]), h = !d.is(".collapsed");
        c = c !== undefined ? c : !h;
        if (c != h) {
      ...
      showEditPageCommentBox: function (a) {
        if (da()) {
          ...
          J(k.myGroups, function (d) {
            c.append(A.dom.buildOne("option", {value: d.name}, [d.displayName]))
          });
          c.val("_private")
        } else C.signIn()
      }, refresh: function () {
        ...
        J(k.pageComments, function (d) {
          c += Q(diigolet.consts.HTML_3DF_SIDEBAR_PAGE_COMMENT, {USER: d.user, CONTENT: d.content, DIIGO_URL: diigolet.consts.DIIGO_SERVER, DATE: d.datetime, LABELS_HTML: a._labelsHtml(d)})
        });
          ...
          function (i) {
            if (i.type == 0 || i.type == 2 || i.type == 1) {
              ...
              J(i.comments, function (m) {
                f++;
                d += Q(diigolet.consts.HTML_3DF_SIDEBAR_INLINE_COMMENT, {HIGHLIGHT_ID: i.id, USER: m.user, CONTENT: m.content, DIIGO_URL: diigolet.consts.DIIGO_SERVER, DATE: m.datetime})
              });
              c = Q(diigolet.consts.HTML_3DF_SIDEBAR_HIGHLIGHT, {ID: i.id, FLOAT_NOTE_CLASS: i.type == 2 ? "floatNote" : "", CONTENT: i.prettyTxt || Ba.html2txt_pretty(i.content), COMMENTS: d});
              a += c
            }
          });
        var h = diigolet.consts.HTML_3DF_SIDEBAR_NO_COMMENTS;
        k.launchMode.threeDForum || (h = h.replace("No comments",
          "No sticky notes"));
        ...
        if (a.length <= 0 || a.length > 500) alert("Comment length should < 500 characters"); else if (Ra(a)) H.notify(diigolet.consts.MSG_COMMENT_TOO_LONG); else {
    ...
    M(X, {
      filterMode: "_all", _labelsHtml: function (a) {
        var c = a.annotationId ? "ic" : "pc", d = this.filterMode, f = "", h = a.canDelete() ? '<a href="javascript:void(0)" class="del" onclick="#{ONCLICK};"><img title="Delete" src="chrome://diigose/skin/pageImage/spacer.gif" style="width:12px;height:12px;cursor:pointer" alt="" /></a>' :
          "";
        if (a.isPublic() && (d == "_all" || d == "_public") && a.user == k.user) f += '<label class="_public"><span>Public</span>DEL</label>'.replace("DEL", Q(h, {ONCLICK: Q("diigolet.handle(event, 'sb_del_#{0}', '#{1}')", [c, a.id])}));
        if (a.isPrivate() && (d == "_all" || d == "_private")) f += '<label class="_private"><span>Private</span>DEL</label>'.replace("DEL", Q(h, {ONCLICK: Q("diigolet.handle(event, 'sb_del_#{0}', '#{1}')", [c, a.id])}));
        J(a.groups, function (i) {
          if (d == i.name || d == "_all") f += Q('<label class="_#{GROUP_NAME}"><a href="#{GROUP_URL}" class="link">#{GROUP_DISPLAY_NAME}</a>#{DEL}</label>',
            {GROUP_NAME: i.name, GROUP_DISPLAY_NAME: i.displayName, GROUP_URL: x.urls.getGroupURL(i.name), DEL: Q(h, {ONCLICK: Q("diigolet.handle(event, 'sb_del_#{0}', '#{1}', '#{2}')", [c, a.id, i.name])})})
        });
        return f
    ...
    var Y = {
        j: null, direction: "normal", shown: false, copyClient: null, init: function () {
          this.create()
        }, create: function () {
          this.j = $(diigolet.consts.HTML_CONTEXT_MENU).css({position: "absolute"}).appendTo(fa.body);
          ...
          this.j.find(".csm-btn").hover(function () {
            var h = $(this).find(".csm-action"), i = h.attr("id");
            ...
            } else i == "diigolet-csm-highlightAndComment" && setTimeout(function () {
              h.parent().find(".diigolet-csm-color").hide();
              h.removeClass("editing")
            }, 350)
          });
          ...
          document.getElementById("diigolet-csm").className =
            a
        }, show: function () {
          ...
          if (c.toString().length > 0) {
            ...
            } else c = c[0].top + $(window).scrollTop() -
              50;
            d = Math.min.apply(null, d);
            a = Math.max.apply(null, a);
            this.j.css({left: d + (a - d) / 2 - 60, top: c}).show().addClass("active");
            var f = this.j;
            setTimeout(function () {
        ...
        j: null, ann: null, p: null, tempAnnId: null, copyClient: null, copyText: "",
        showDelay: 0, showTimer: null, hideDelay: 350, hideTimer: null, shown: false, cancelShow: function () {
          clearTimeout(this.showTimer);
          this.showTimer = null
        }, cancelHide: function () {
          clearTimeout(this.hideTimer);
          ...
          var d = this;
          if (!B.isEditing()) {
            var f = $(a.target).offset(), h = $(a.target).width(), i = {pageX: a.pageX, pageY: a.pageY, offsetTop: f.top, offsetLeft: f.left, width: h};
            d.cancelHide();
            d.cancelShow();
            d.showTimer = setTimeout(function () {
              d.show(i, c)
          ...
          $("#diigolet-context-yellow,#diigolet-context-blue,#diigolet-context-green,#diigolet-context-pink").click(function () {
            var c = $(this).attr("color");
            if (!a.ann.extra || a.ann.extra == "undefined") a.ann.extra = {color: c};
            ...
            chrome.runtime.sendMessage({name: "editItem", cmd: "changeColor", annotation: a.ann});
          ...
          this.j = $(diigolet.consts.HTML_ANN_MENU).css({position: "absolute"}).hide().appendTo(fa.body).hide()
        }, show: function (a, c) {
          if (c.id != this.tempAnnId) {
            ...
            this.ann = c;
            this.buildMenu();
            this.j.css({left: curcorX + 100 > $(window).width() ? $(window).width() - 212 : this.j.hasClass("onlyMy") ? curcorX - 100 : curcorX - 31, top: curcorY - 65}).show();
            this.shown = true;
            this.tempAnnId = c.id;
            var d = "";
        ...
        tipMsg: function (a) {
          var c = "#{MODE} #{WHAT} by #{REALNAME}", d = {REALNAME: a.realName};
        ...
        j: null, ann: null, showDelay: 200, showTimer: null, hideDelay: 300, hideTimer: null,
        editDelay: 350, editTimer: null, shown: false, cancelShow: function () {
          clearTimeout(this.showTimer);
          this.showTimer = null
        }, cancelHide: function () {
          clearTimeout(this.hideTimer);
          ...
          this.hide();
          this.ann = a;
          this.j = $("div." + L.HIGHLIGHT_ID_CLASS + a.id).bind("mouseout", function () {
            c.scheduleHide()
          ...
          Y.shown && Y.hide();
          if (c.comments.length <= 0) if (c.type == diigolet.consts.ANNOTATION_TYPE_TEXT) this.j.css({top: -23}); else {
      ...
      Xa = {
        j: null, init: function () {
          ...
          f.children("div:first").attr("class",
            c).children("p:first").html(a);
          f.show();
    ...
    La.Class = {
      create: function (a, c) {
        ...
        if (!d.prototype.initialize) d.prototype.initialize =
          function () {
          };
        ...
        for (var f in c) {
          ...
          if (d && typeof h == "function" && A.func.argumentNames(h)[0] == "$super") {
            var i = h;
            h = A.extend(A.func.wrap(function (m) {
              return function () {
    ...
    var O = La.Class.create({
      initialize: function (a) {
        ...
        O.contacts = a;
        O.contactListsID = [];
        for (var d = 0; d < O.contacts.length; d++) O.contacts[d].type ==
        "list" && O.contactListsID.push(d)
      }, showNotice: function () {
        ...
        for (var a = this, c = 0; c < this.match.length; c++) {
          var d = this.match[c], f = O.contacts[d], h = $("<div id=cI_" + c + ' class="cItem"/>');
          switch (f.type) {
            case "list":
        ...
        this.contactListInner.height() > this.maxHeight && this.contactListInner.css({
        ...
        if (c[0]) {
          ...
          if (this.currentItem == 0) {
            this.contactListInner[0].scrollTop =
              0;
            return false
          }
        ...
        if (a[0]) a[0].className =
          a[0].className.replace(/\s?hover/gi, "")
      }, wrapItem: function (a) {
        if (typeof a == "undefined") {
          ...
          if (this.currentItem == -1) {
            emailR = /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/;
            emailR.test(a) ? O.contacts.push({type: "email", id: a}) : O.contacts.push({type: "friend", id: a, extra: {real_name: a}});
    ...
    var Ma = {
      ...
      get2: function (a, c, d) {
        ...
        if (h = f.cache[c]) {
          d && d(h);
          return h
        } else C.makeAnnotatedLink(a, c, function (i) {
      ...
      shown: false, j: null, tabs: {}, init: function () {
        ...
        var a = this.j, c = $(window), d = c.width();
        c = c.height();
        var f = parseInt(a.css("left")), h = parseInt(a.css("top")), i = a.outerWidth(), m = a.outerHeight();
        ...
        var a = this, c =
          a.j = $(diigolet.consts.HTML_DLG_SHARE).eq(0).appendTo(document.body).hide();
    ...
    V.tabs.email = {
      init: function () {
        ...
        k.pageComments.length > 0 || k.annotations.length > 0 ? Ma.get(k.bookmark.url, function (c) {
          a.updateURL(c)
        ...
        a = Q('<p><a class="diigoAnnotatedLink" href="#{1}" title="#{0}">#{0}</a></p>',
        ...
        a = {toAllFriends: false, toUsers: [], toEmails: [], toLists: [], mode: 2, subject: a, body: this.composeMessage(A.string.stripTags(this.jTxtMsg.val()))};
    ...
    DlgShare_piku = {
      onMyContactsUpdate: function () {
        this.piku &&
        this.piku.setContacts(k.myContacts)
      }, initAutocompleteContacts: function () {
        this.piku = new O({rec: "#forwardTo", contacts: k.myContacts, maxRecipients: 20, width: "100%", maxHeight: 180, scanType: "all"})
      }
    };
    ...
    x.AnnotationFormatter = {
      format: function (a) {
        ...
        var f =
          "";
        if (a.includePageComments) f += "<ul>" + $.map($(k.pageComments).filter(function (h) {
        ...
        f += "<ul>" + $.map($(k.annotations).filter(function (h) {
          return (c ? true : h.user == k.user) && (d ? true : h.mode != PRIVACY_MODE_PRIVATE)
        }), function (h) {
          var i = "";
          if (h.type == diigolet.consts.ANNOTATION_TYPE_TEXT) i = A.string.stripTags(h.content);
          else if (h.type == diigolet.consts.ANNOTATION_TYPE_IMAGE) i = A.string.makeTpl('<img src="#{0}" title="#{1}" alt="#{1}">(image)', [h.extra.imageUrl, ""]); else if (h.type == diigolet.consts.ANNOTATION_TYPE_FLOATNOTE) i = '<img src="http://www.diigo.com/images/v2/float_note.gif" />(floating sticky note)'; else if (h.type == diigolet.consts.ANNOTATION_TYPE_FLASH) i = "(flash movie)" + h.content; else if (h.type == diigolet.consts.ANNOTATION_TYPE_VIDEO) i = "(video)" + h.content;
          return A.string.makeTpl('<li style="line-height:150%;margin-bottom:.6em;">#{0} #{1} #{2}</li>',
            [i, h.groups ? "" : "", "<ul>" + $.map($(h.comments).filter(function (m) {
              return (c ? true : m.user == k.user) && (d ? true : m.mode != PRIVACY_MODE_PRIVATE)
            }), function (m) {
              return '<li style="line-height:150%;margin-bottom:.6em;">' + A.string.stripTags(m.content) + A.string.makeTpl(' <span style="font-size:11px;color:#aaa">comment by <a href="#{0}">#{1}</a></span>', [x.urls.getUserHomepageURL(m.user), m.realName]) + "</li>"
            }).join("\n") + "</ul>"])
        }).join("\n") + "</ul>";
        return f
      }
    ...
    jQuery.Draggable =
      function (a, c) {
        ...
        function f(z) {
          ...
          if (!z.undraggable) {
            m = true;
            var w = parseInt(a.css("left")), o = parseInt(a.css("top")), p = z.pageX - r, n = z.pageY - y;
            if (l.axis == "y") p = 0; else if (l.axis == "x") n = 0;
    ...
    (function (a) {
      a.fn.autoGrowInput = function (c) {
        ...
        this.filter("input:text").each(function () {
          var d = c.minWidth || a(this).width(), f = "", h = a(this), i = a("<tester/>").css({position: "absolute", top: -9999, left: -9999, width: "auto", fontSize: h.css("fontSize"), fontFamily: h.css("fontFamily"), fontWeight: h.css("fontWeight"), letterSpacing: h.css("letterSpacing"), whiteSpace: "nowrap"});
          i.insertAfter(h);
    ...
    (function (a) {
      ...
      a.fn.Gtooltip = function (f) {
        var h = {fontSize: 12, bgColor: "black", fColor: "white", position: "bottom", content: ""};
        return this.each(function () {
          function i() {
            y.text(l.data("gtooltip"));
            var w;
            w = l.offset().left;
            var o = l.offset().top, p = l.width(), n = l.height(), q = r.width(), t = r.height(), s, u, E, G, D = navigator.userAgent.toLowerCase();
            D = D.indexOf("macintosh") != -1 ||
            D.indexOf("mac os x") != -1 || D.indexOf("linux") != -1 ? true : false;
            switch (m.position) {
              case "bottom":
                G = D ? -9 : -10;
                s = parseInt((q + 2) / 2);
          ...
          var m = a.extend(h, f || {}), l = a(this), r, y, z;
    ...
    (function (a) {
      ...
      function c(f) {
        return a.isFunction(f) || typeof f == "object" ? f : {top: f, left: f}
      }

      var d = a.scrollTo = function (f, h, i) {
        return a(window).scrollTo(f, h, i)
      };
      d.defaults = {axis: "xy", duration: parseFloat(a.fn.jquery) >= 1.3 ? 0 : 1, limit: true};
      d.window =
        function () {
      ...
      a.fn.scrollTo = function (f, h, i) {
        ...
        return this._scrollable().each(function () {
          function m(n) {
            r.animate(w, h, i.easing, n && function () {
              n.call(this, y, i)
            })
          }

          if (f != null) {
            var l = this, r = a(l), y = f, z, w = {}, o = r.is("html,body");
            switch (typeof y) {
              case "number":
              case "string":
                if (/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(y)) {
            ...
            var p = a.isFunction(i.offset) &&
              i.offset(l, y) || i.offset;
            a.each(i.axis.split(""), function (n, q) {
              var t = q == "x" ? "Left" : "Top", s = t.toLowerCase(), u = "scroll" + t, E = l[u], G = d.max(l, q);
              if (z) {
      ...
      d.max = function (f, h) {
        var i = h == "x" ? "Width" : "Height", m = "scroll" + i;
        if (!a(f).is("html,body")) return f[m] - a(f)[i.toLowerCase()]();
        i = "client" + i;
        var l = f.ownerDocument.documentElement, r = f.ownerDocument.body;
    ...
    (function (a) {
      ...
      a.scrollmarker.fn.extend({
        init: function () {
          var c = this, d = this.place.attr("class").match(/id_([\w]+)/) ? this.place.attr("class").match(/id_([\w]+)/)[0] : "";
          a("#" + d).length != 0 && a("#" + d).remove();
          this.marker = a('<div class="diigo-scrollmarker"></div>').attr("id", d).appendTo(a("body")).click(function () {
            c.locate()
          }).addClass(this.options.markerClass || this.place.data("scrollmarker-class"));
          if (this.place.hasClass("blue")) this.marker.css("background-color", "#0087f7"); else if (this.place.hasClass("green")) this.marker.css("background-color", "#00a256"); else this.place.hasClass("pink") ? this.marker.css("background-color", "#ff3399") : this.marker.css("background-color", "#ffb000");
          ...
          this.marker.height();
          var d = a("#main").height(), f = a(window).height(), h = navigator.userAgent.toLowerCase();
    ...
    var Ka = function () {
        ...
        var c =
          diigolet.consts.HTML_HIGHLIGHT_SHARE_WINDOW, d = {};
        d.enabled = false;
        d.init = function () {
          var f = this;
          f.create();
            ...
            if (f.enable) {
              ...
              if (h === "diigolet-highlight-share-copybtn") {
                ...
                setTimeout(function () {
                  ...
                  1500)
              } else if (h === "diigolet-highlight-share-cancelbtn") f.hide(); else if (h === "diigolet-highlight-share-twitter") window.open("https://twitter.com/intent/tweet?text=" + encodeURIComponent(f.editor.val()) + " @diigo", "sharer", "toolbar=1,status=0,resizable=1,scrollbars=1,width=700,height=453"); else if (h === "diigolet-highlight-share-facebook") {
                h = encodeURIComponent(document.title);
                var i = encodeURIComponent(f.ann.prettyTxt), m = encodeURIComponent(f.url);
                window.open("http://www.facebook.com/sharer.php?s=100&p[title]=" +
                  h + '&p[summary]="' + i + '"&p[url]=' + m + "&p[images][0]=https://www.diigo.com/images/v6/logo.png", "sharer", "toolbar=1,status=0,resizable=1,scrollbars=1,width=700,height=453")
              }
            }
          });
        ...
        j: null, k: null, shown: false, init: function () {
          ...
          for (var c = k.annotations, d =
            0; d < c.length; d++) a.add(c[d]);
          if ($("#diigo-annotationList-box").find(".diigo-annotationList-item").length === 0) {
            $("#diigo-annotationList-box").append('<div id="diigo-annotationList-noItem">You have no annotations yet. Create a highlight or sticky note to see it here.</div>');
            $("#diigo-annotationList-toolbar").toggle($("#diigo-annotationList-box").find(".diigo-annotationList-item").length > 0)
          }
          k.orphanHighlights.length === 0 && $("#diigo-annotationList-toolbar").find("span").toggle(k.orphanHighlights.length >
            0);
          ...
          if (a.onlyInGroup == false && a.user == k.user) if (a.type == diigolet.consts.ANNOTATION_TYPE_TEXT) {
            ...
            d.find(".diigo-annotationList-item-copy").on("click",
              function (h) {
                h.stopPropagation();
          ...
          if (this.j) {
            ...
            if (f) switch (a) {
              case "remove":
                f.remove();
                $("#diigo-annotationList-box").find(".diigo-annotationList-item").length === 0 && $("#diigo-annotationList-box").append('<div id="diigo-annotationList-noItem">You have no annotations yet. Create a highlight or sticky note to see it here.</div>');
                break;
              case "changeColor":
      ...
      sa = {
        diigoImageClipMode: false, imageSrc: "", imageTop: 0, shown: false, init: function () {
          this.create()
        }, create: function () {
          var a = this;
          if (!($("#diigo-image-clipper").length > 0)) {
            ...
            $("#diigo-image-menu").bind("mouseenter", function () {
              d != null && clearTimeout(d);
              $("#diigo-image-menu").animate({width: "63px"},
                200)
          ...
          $(document).bind("mousemove", function (d) {
            if (d.target.tagName == "IMG") {
              ...
              d = d.target;
              var f = $(d).offset().left, h = $(d).offset().top, i = $(d).width(), m = $(d).height();
              if (a.shown == false) if (i >= 200 || m >= 200) {
                c = h + m > document.body.scrollTop + window.innerHeight ? setTimeout(function () {
                  $("#diigo-image-clipper").css("top",
                    h + 3 + "px").css("left", f + i - 55 + "px").show()
                }, 350) : setTimeout(function () {
                  $("#diigo-image-clipper").css("top", h + m - 29 + "px").css("left", f + i - 55 + "px").show()
                }, 350);
                a.shown = true
              }
              ...
              i = d.width();
              m = d.height();
              if (i >= 200 || m >= 200) h + m > document.body.scrollTop + window.innerHeight ? $("#diigo-image-clipper").css("top", h + 3 + "px").css("left", f + i - 55 + "px").show() : $("#diigo-image-clipper").css("top",
                h + m - 29 + "px").css("left", f + i - 55 + "px").show()
          ...
          if (da()) if (!k.permissions.premium || k.permissions.image) chrome.extension.sendRequest({name: "saveImageToDiigo", details: {srcUrl: sa.imageSrc}, Type: "tag"}); else {
            ab.init();
            ab.show("Save images")
          }
        ...
        saveImage: function (a) {
          ...
          if (/data:image\/.*;base64/.test(a)) {
            ...
            f.onload = function () {
              ...
              h = h.toDataURL();
              c.uploadImage({data: h, type: "attacth", dtype: "png"}, {top: c.imageTop})
            }
          }
          ...
          C.uploadImage({
            dataURL: a.data,
            title: document.title, tags: [], mode: 2, src_url: d, src_title: document.title, single_item: false
          }, "image", false, d, c, a.dtype, "", true)
        }
      }, sb = {
        j: null, init: function () {
        ...
        j: null, k: null, init: function () {
          ...
          $(document.body).on("mouseenter", "pre", function () {
            console.log("sdfs");
            var c = $(this).offset().left, d = $(this).offset().top, f = $(this).outerWidth(), h = $(this).outerHeight();
            d = d + h > fa.body.scrollTop + window.innerHeight ? d + 5 : d + h - 29;
            if ($(this).attr("data-diigo-clip") == "true") {
              d += 4;
              a.k.css("top", d + "px").css("left", c + f - 57 + "px").show()
            } else a.j.css("top", d + "px").css("left", c + f - 29 + "px").show();
            a.block = this
          });
          ...
          this.j.on("click", function () {
            var c = {user: k.user, realName: k.realName, content: a.block.outerHTML, type: diigolet.consts.ANNOTATION_TYPE_TEXT, nth: 1, code: true, top: $(a.block).offset().top};
