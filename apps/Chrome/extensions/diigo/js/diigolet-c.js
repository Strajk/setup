if (window.diigolet == undefined) {
  ...
  try {
    (function () {
      ...
      var ta = [Array.prototype, ["slice", "push", "indexOf"], String.prototype, ["trim"]]; var la; var ha; var N; var Aa; var M
      la = 0
  ...
  (function () {
    ...
    function M () {
      for (var a = [].slice.call(arguments), c = a.shift(), d = 0, f = a.length, h; h = a[d], d < f; d++) {
        for (var i in h) {
          c[i] =
        h[i]
        }
    ...
    function qa (a) {
      ...
      var l = []; var r; var y; var z; var w; var o; var p; var n; var q
      l = (function (t) {
        var s; var u = t.length
        s = u + 8
    ...
    function nb () {
      ...
      var c = k.myTagsWithCount.slice(0, 101); var d = c[0].count; var f = c.length
      c.sort(function (m, l) {
        ...
        if (m != "undefined") {
          ...
          if (m == "object") {
            ...
            if (i.constructor === Date) {
              ...
              m = i.getUTCDate()
              if (m < 10) m = "0" + m
              var r = i.getUTCFullYear(); var y = i.getUTCHours()
              if (y < 10) y = "0" + y
    ...
    if (!Array.prototype.indexOf) {
      Array.prototype.indexOf = function (a, c) {
        var d = this.length; var f = Number(c) || 0
        ...
        A.each(a, function (f, h) {
          if (h) {
            if (f && typeof f === "object") {
              A.isArray(f) && A.each(f, function (i) {
                c(h, i)
              })
            } else c(h, f)
          }
    ...
    A.dom = {
      build2: function () {
        var a = []; var c = arguments; var d; var f; var h = 0; var i
      ...
      getDocumentSource: function () {
        var a = document; var c = document.doctype; var d = ""
        if (c) {
    ...
    T.extend = function (a, c) {
      ...
      var h = f.constructor; var i = f.constructor = function () {
        if (!T._prototyping) {
    ...
    jQuery.Draggable = function (a, c) {
      ...
      function f (z) {
        ...
        var o = parseInt(a.css("top")); var p = z.pageX - r; var n = z.pageY - y
        ...
        switch (p.keyCode) {
          ...
          default:
            ...
            z = setTimeout(function () {
              if (y.val().length < w.minChars) o.hide(); else {
                a: {
                  var n = y.val()
                  if (w.mode == "multiple") {
                    var q = d(n); var t = ""
    ...
    x.handlers = {
      ...
      readlater: function () {
        if (da()) {
          if (k.bookmark.unread == true) H.notify("This page has already been put into Reading List.", 2E3); else {
      ...
      uploadCache: function () {
        ...
        C.uploadCacheCheckbf(a, 2, function (c) {
          ...
          if (c.code == 2) H.notify("Upload Succeeded", 5E3, 2); else {
            c.code == 0 ? H.notify(c.msg && c.msg.length > 0 ? c.msg : "Your upload failed. Please try again later.",
    ...
    var ya = false; var Ga = false; var k = window.Ctx = {
      ...
      paintAllAnnotations: function () {
        ...
        for (f = 0; f <= c.length; f++) {
          if ($("." + c[f]).length == 1) $("." + c[f]).scrollmarker(); else {
            d = $("." + c[f])
            $(d[0]).scrollmarker()
          }
        }
    ...
    var pb = {
      ...
      start: function () {
        function a () {
          var d = ka.scrollTop(); var f = ka.scrollLeft(); var h = ka.width()
    ...
    var $a = {
      ...
      parseTags: function (a, c) {
        ...
        for (var f = [], h = [], i = false, m = 0, l =
          a.length, r; r = a.charAt(m), m < l; m++) {
          if (r == "\"") {
            if (i) {
              i = false
              d()
            } else i = true
          } else if (i) f.push(r); else /\s/.test(r) || r == "," ? d() : f.push(r)
        }
        d()
        if (c) {
    ...
    var I = T.extend({
      ...
      getPageOffset: function () {
        ...
        var c = window
        var d = { left: 0, top: 0 }; var f = 0; var h = 0
    ...
    var ba = I.extend({
      constructor: function (a) {
        ...
        if (!this.content) {
          if (this._focusedNode) {
            this.content =
          Q("<img src=\"#{0}\" title=\"#{1}\" alt=\"#{2}\" />", [ba.makeAbsUrl(this._focusedNode.src, a), this._focusedNode.title, this._focusedNode.alt])
        ...
        if (!this.saved && this._focusedNode) {
          for (var c = ba.makeRelUrl(this.extra.imageUrl, a), d = ba.makeAbsUrl(this.extra.imageUrl,
              a), f = document.getElementsByTagName("img"), h = 0, i = 0, m = f.length, l; l = f[i], i < m; i++) {
      ...
      getEle: function () {
        ...
        if (a.size() == 0) {
          for (var c = ba.makeRelUrl(this.extra.imageUrl, k.bookmark.url), d = ba.makeAbsUrl(this.extra.imageUrl, k.bookmark.url), f = document.getElementsByTagName("img"), h = 0, i = 0, m = f.length, l; l = f[i], i < m; i++) {
    ...
    M(ba, {
      ...
      getBaseUrl: function (a, c) {
        var d = a; var f = d.replace(/:\/\//, "123")[(c ? "i" : "lastI") + "ndexOf"]("/")
    ...
    var Ja = I.extend({
      ...
      fixExtra: function () {
        ...
        }).length; var c = $(document); var d = c.scrollTop(); var f = c.scrollLeft(); var h = c.height()
        c = c.width()
    ...
    var C = {
      ...
      invokePost: function (a, c, d) {
        ...
        var h = "<iframe frameborder='0' scrolling='no' id='diigo_upload_iframe_" +
          f + "' style='width: 400px; height: 30px; margin: 0; padding: 0;' src='#' width='400px' height='30px'></iframe>"; var i = document.createElement("div")
      ...
      saveBookmark: function (a, c) {
        var d = k.bookmark; var f = { url: d.url, mode: d.mode, title: d.title, tags: d.tags, description: d.description, unread: d.unread }
      ...
      updateExtra: function (a) {
        this.invoke("annotation_updateExtra", {
          ...
          id: a.id,
          idsInGroup: W(Da(a.groups, function (c) {
      ...
      updatePremium: function () {
        if (k.permissions && k.permissions.premium) {
          ...
          if (!$.browser.supportPositionFixed && $.browser.ieBelow8) {
            this.ie7Width += 100
            var a = ka.scrollTop(); var c = ka.scrollLeft(); var d = ka.width()
    ...
    var U = {
      ...
      adjustPosition: function () {
        var a = this.j; var c = $(window); var d = c.width()
        c = c.height()
        var f = parseInt(a.css("left")); var h = parseInt(a.css("top"))
        f = a.outerWidth()
        var i = a.outerHeight()
        a.css("left", f =
          d - f + 1)
      ...
      create: function () {
        ...
        $("#diigolet-panel-moreBtn").click(function () {
          var c = $(".optList", this).toggleClass("dropdownShown"); var d = function () {
            c.removeClass("dropdownShown").unbind("mouseleave", d)
            $(document.body).unbind("click", d)
          }
          c.hasClass("dropdownShown") ? setTimeout(function () {
        ...
        $("#diigolet-panel-feedback").click(function () {
          var c =
            $(".optList", this).toggleClass("dropdownShown"); var d = function () {
            c.removeClass("dropdownShown").unbind("mouseleave", d)
            $(document.body).unbind("click", d)
          }
          c.hasClass("dropdownShown") ? setTimeout(function () {
      ...
      fold: function () {
        var a = this; var c = parseInt(this.j.css("left")); var d = $("#diigolet-panel-main").find(".diigolet-panel-btn").length; var f = 0
    ...
    var S; var L; var Ba = S = L = {
      ...
      paint: function (a) {
        ...
        var h = this; var i = I.find(a); var m = L.HIGHLIGHT_ID_CLASS + i.id; var l = i.comments
        if (i.paintedSuccessfully) {
          ...
          if (r) {
            ...
            if (r.startNode === r.endNode) {
              ...
              var y = r.startNode.splitText(r.startOffset); var z = r.endNode.splitText(r.endOffset).previousSibling; var w = false; var o = []; var p = 0; var n = i.prettyTxt.replace(/\s/g, "").length;
      ...
      adjustColor: function (a) {
        ...
        $("em." + L.HIGHLIGHT_ID_CLASS + a.id).each(function (d, f) {
          var h = $(f); var i = Ta(h.css("backgroundColor")); var m = Ta(h.css("color"))
          var l = c(m); var r = c(i)
          if (l > r) {
            m = l
            l = r
      ...
      checkSelection: function () {
        var a; var c = { ok: false, txt: "", html: "", msg: "", pen: false }; var d = null
    ...
    var B = {
      ...
      init: function () {
        if ($("#diigolet-dlg-sticky").length === 0) {
          ...
          $("#FN-group-content-container").on("click", ".FN-group-comment-item-delete", function () {
            var c = $(this).parent().parent().attr("data-cid"); var d = $("#FN-current-group").find("span").attr("data-group")
      ...
      updateColor: function (a, c) {
        ...
        if (c == "click") {
          if (!this.ann.extra || this.ann.extra == "undefined") this.ann.extra = { color: a }; else {
            this.ann.extra.color =
            a
          }
      ...
      mergePrivateComments: function (a) {
        ...
        setTimeout(function () {
          for (var i = 0; i < f.length; i++) {
            var m = ea.find(f[i]); var l = m.getAnnotation()
      ...
      shareToNewGroup: function () {
        var a = $("#FN-post-form"); var c = a.find("textarea"); var d = c.val(); var f = a.find("select"); var h = f.val()
        if (d.match(/^\s*$/)) {
          c.addClass("notify")
          setTimeout(function () {
            c.removeClass("notify")
      ...
      showActionDropdown: function () {
        var a = this.j.find("div.IconFeild").offset(); var c = K("diigolet-annMenu")
      ...
      uploadPrivateComment: function () {
        var a = $("#FN-private-editor").val(); var c = $("#FN-private-delete").attr("data-cid")
      ...
      updatePos: function (a) {
        ...
        var c = this.ann; var d = this.j.find("div.diigoletFNContent")
        d.css({ height: "" })
        ...
        var i = c + $(window).width() - d.width() - 10; var m = h + $(window).height() - d.height() - 10
        if (f > i) f = i
        if (f < c) f = c
        if (a > m) a = m
        if (a < h) a = h
    ...
    M(B, {
      ...
      scheduleShow: function (a, c) {
        var d = this
        var f = { pageX: a.pageX - 10, pageY: a.pageY - 10 }
        d.cancelHide()
        d.cancelShow()
    ...
    M(B, {
      ...
      _labelsHtml: function (a) {
        var c = this.filterMode; var d = ""; var f = ""
      ...
      addInlineComment: function (a) {
        if (a.mode == diigolet.consts.PRIVACY_MODE_PRIVATE) {
          ...
          var c = a.groups[0].name; var d = a.groups[0].displayName
      ...
      getCommentsInfo: function (a) {
        var c = 0; var d = 0; var f = a.length; var h
      ...
      ifMoreThanOnePrivateComment: function (a) {
        var c = 0; var d = a.length; var f
        if (d === 0) return false
        for (f = 0; f < d; f++) a[f].mode == diigolet.consts.PRIVACY_MODE_PRIVATE && c++
        return c > 1
      },
      updatePrivateComments: function (a) {
        var c = a.length; var d = ""; var f = ""; var h; var i = this.getCommentCount("private", a); var m
        if (i >= 1) {
          for (m = 0; m < c; m++) {
    ...
    M(B, {
      ...
      groupEditor: {
        ...
        submitGroupComment: function () {
          var a = this; var c = a.jEdit.find("textarea").val()
          if (c) {
        ...
        show: function () {
          var a = $(".diigoletFNPriSlct").empty(); var c = B.ann; var d = B.filterMode
          if ((d == "_all" || d == "_public") && (true) && (c ? !c.onlyInGroup && c.getComments("_private").length == 0 : true)) B.NO_PUBLIC_STICKY_NOTES_ALLOWED || a.append("<option value=\"_public\">Public</option>")
    ...
    var R = {
      ...
      show: function (a, c) {
        if (!(!ia() || this.shown && this.j.is(":visible"))) {
          ...
          if (k.recommendedTagsLoaded) d.showRecommendedTags(k.recommendedTags); else {
            ...
            var f = k.bookmark; var h = f.getTitle()
      ...
      showTagList: function (a, c) {
        var d = this; var f = $(d._tagContainerIdForTagListName(a))
        if (a == "group") {
          f.show()
          f.find(".tagButton").remove()
        } else if (a == "recommend" && f.find(".tagButton").length > 0) return
        if (c) {
          if (c.length == 0) f.hide(); else {
            a == "group" && f.find(".loading").hide()
            var h = k.bookmark; var i = k.myTags
            f.find(".tagButton").remove()
            J(c, function (m) {
      ...
      toggleTag: function (a, c) {
        ...
        var f = x.parseTags(d.val(), true); var h = $.inArray(a, f)
      ...
      updateTagStates: function () {
        var a = this; var c = $("#Diigo-Bookmark-Tag-Input"); var d = x.parseTags(c.val(), true)
        $("#Diigo-Bookmark-Tag-Cloud").find(".Diigo-Bookmark-Tag-item").each(function () {
          var f = $(this); var h = f.text()
      ...
      showGroupTags: function () {
        ...
        var c = null; var d = $("#diigo-group").find("select").val()
        if (d != -1) c = d
      ...
      placeCursorAtLast: function (a) {
        var c = this; var d = a.value.length
        setTimeout(function () {
      ...
      create: function () {
        ...
        $("#diigolet-dlgBm-btnSaveandmore").click(function (d) {
          ...
          var f = encodeURIComponent($("#Diigo-Bookmark-Url").val()); var h = encodeURIComponent($("#Diigo-Bookmark-Tag").val())
        ...
        $("#diigo-list-addBtn").on("click", function () {
          if (!$(this).hasClass("processing")) {
            var d = $("#diigo-list-addInput").val(); var f = $("#diigo-list-add .diigo-alert-tip"); var h = []; var i = k.myBmLists.length; var m
      ...
      isURL: function (a) {
        return !!/^(https|http|ftp|rtsp|mms)+:\/\//.test(a)
      },
      buildTagCloud: function (a, c) {
        ...
        if (k.myTagsWithCount.length == 0) {
          var d = document.getElementById(a); var f = document.createElement("span")
          f.id = "no-tag"
          f.innerHTML = "No tags"
          d.appendChild(f)
          ...
          var m = i.maxCount
          f = i.a
          var l = i.b; var r = i.c; var y = d.length
      ...
      updateGroups: function (a) {
        var c = this; var d = $("#diigo-group").find("select").empty().unbind().removeClass("processing")
      ...
      submitAndClose: function () {
        var a = true; var c = ""; var d = $("#Diigo-Bookmark-Url-Input").val()
      ...
      saveThisLink: function () {
        var a = {}; var c = true; var d = $("#Diigo-Bookmark-Url-Input").val()
        if ($("#Diigo-Bookmark-Title-Input").val().match(/^\s*$/)) {
          c = false
          $("#Diigo-Bookmark-Title").find(".diigo-alert-tip").show()
        }
      ...
      togglePanel: function (a, c) {
        var d = $({ inline: "#d3df-togglePanelInline", page: "#d3df-togglePanelPage" }[a]); var f = $({ inline: "#d3df-inlineCommentBox", page: "#d3df-pageCommentBox" }[a]); var h = !d.is(".collapsed")
        c = c !== undefined ? c : !h
        if (c != h) {
      ...
      popOut: function (a) {
        var c = this.j.find("div.popOut"); var d = c.is(".popIn")
        ...
        if (d) {
          ...
          if ($.browser.supportPositionFixed) {
            if (a) c.css({ position: "fixed" }); else {
              a = qb.docScroll()
    ...
    M(X, {
      filterMode: "_all",
      _labelsHtml: function (a) {
        var c = a.annotationId ? "ic" : "pc"; var d = this.filterMode; var f = ""; var h = a.canDelete() ? "<a href=\"javascript:void(0)\" class=\"del\" onclick=\"#{ONCLICK};\"><img title=\"Delete\" src=\"chrome://diigose/skin/pageImage/spacer.gif\" style=\"width:12px;height:12px;cursor:pointer\" alt=\"\" /></a>"
          : ""
    ...
    var Y = {
      ...
      create: function () {
        ...
        var a = $("#diigolet-csm-highlight"); var c = $("#diigolet-csm-highlightAndComment")
        a.click(function (h) {
        ...
        this.j.find(".csm-btn").hover(function () {
          var h = $(this).find(".csm-action"); var i = h.attr("id")
          ...
          if (i == "diigolet-csm-highlight") {
            ...
            i == "diigolet-csm-highlightAndComment" && setTimeout(function () {
              h.parent().find(".diigolet-csm-color").hide()
              h.removeClass("editing")
            }, 350)
          }
        ...
        $("#diigolet-csm-search").click(function () {
          ...
          window.open("https://www.google.com/search?q=" + encodeURIComponent(h))
          return false
        })
      ...
      scheduleShow: function (a, c) {
        var d = this
        if (!B.isEditing()) {
          var f = $(a.target).offset(); var h = $(a.target).width(); var i = { pageX: a.pageX, pageY: a.pageY, offsetTop: f.top, offsetLeft: f.left, width: h }
          d.cancelHide()
          d.cancelShow()
          d.showTimer = setTimeout(function () {
            d.show(i, c)
      ...
      tipMsg: function (a) {
        var c = "#{MODE} #{WHAT} by #{REALNAME}"; var d = { REALNAME: a.realName }
      ...
      scheduleShow: function (a, c) {
        var d = this; var f = { screenX: a.screenX, screenY: a.screenY }
        d.cancelHide()
        d.cancelShow()
        d.showTimer = setTimeout(function () {
          d.show(f, c)
      ...
      show: function (a, c) {
        ...
        if (c.comments.length <= 0) {
          if (c.type == diigolet.consts.ANNOTATION_TYPE_TEXT) this.j.css({ top: -23 }); else {
    ...
    var O = La.Class.create({
      ...
      showContacts: function () {
        ...
        for (var a = this, c = 0; c < this.match.length; c++) {
          var d = this.match[c]; var f = O.contacts[d]; var h = $("<div id=cI_" + c + " class=\"cItem\"/>")
          switch (f.type) {
            case "list":
      ...
      hoverItem: function (a) {
        ...
        if (c[0]) {
          ...
          var d = a + this.contactListInner.height(); var f = c.offset().top
          c = f + c.height()
    ...
    var Ma = {
      ...
      adjustPosition: function () {
        var a = this.j; var c = $(window); var d = c.width()
        c = c.height()
        var f = parseInt(a.css("left")); var h = parseInt(a.css("top")); var i = a.outerWidth(); var m = a.outerHeight()
    ...
    jQuery.Draggable =
      function (a, c) {
        ...
        function f (z) {
          ...
          if (!z.undraggable) {
            m = true
            var w = parseInt(a.css("left")); var o = parseInt(a.css("top")); var p = z.pageX - r; var n = z.pageY - y
    ...
    (function (a) {
      a.fn.autoGrowInput = function (c) {
        ...
        this.filter("input:text").each(function () {
          var d = c.minWidth || a(this).width(); var f = ""; var h = a(this); var i = a("<tester/>").css({ position: "absolute", top: -9999, left: -9999, width: "auto", fontSize: h.css("fontSize"), fontFamily: h.css("fontFamily"), fontWeight: h.css("fontWeight"), letterSpacing: h.css("letterSpacing"), whiteSpace: "nowrap" })
          i.insertAfter(h)
      ...
      a.fn.Gtooltip = function (f) {
        ...
        return this.each(function () {
          function i () {
            ...
            var w
            w = l.offset().left
            var o = l.offset().top; var p = l.width(); var n = l.height(); var q = r.width(); var t = r.height(); var s; var u; var E; var G; var D = navigator.userAgent.toLowerCase()
            D = !!(D.indexOf("macintosh") != -1 ||
            D.indexOf("mac os x") != -1 || D.indexOf("linux") != -1)
            switch (m.position) {
              case "bottom":
                G = D ? -9 : -10
                s = parseInt((q + 2) / 2)
          ...
          var m = a.extend(h, f || {}); var l = a(this); var r; var y; var z
    ...
    (function (a) {
      ...
      a.fn.scrollTo = function (f, h, i) {
        ...
        return this._scrollable().each(function () {
          ...
          if (f != null) {
            var l = this; var r = a(l); var y = f; var z; var w = {}; var o = r.is("html,body")
            switch (typeof y) {
              case "number":
              case "string":
                if (/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(y)) {
            ...
            a.each(i.axis.split(""), function (n, q) {
              var t = q == "x" ? "Left" : "Top"; var s = t.toLowerCase(); var u = "scroll" + t; var E = l[u]; var G = d.max(l, q)
              if (z) {
      ...
      d.max = function (f, h) {
        var i = h == "x" ? "Width" : "Height"; var m = "scroll" + i
        if (!a(f).is("html,body")) return f[m] - a(f)[i.toLowerCase()]()
        i = "client" + i
        var l = f.ownerDocument.documentElement; var r = f.ownerDocument.body
    ...
    (function (a) {
      ...
      a.scrollmarker.fn.extend({
        init: function () {
          var c = this; var d = this.place.attr("class").match(/id_([\w]+)/) ? this.place.attr("class").match(/id_([\w]+)/)[0] : ""
        ...
        position: function () {
          ...
          this.marker.height()
          var d = a("#main").height(); var f = a(window).height(); var h = navigator.userAgent.toLowerCase()
    ...
    var Ka = (function () {
      ...
      var c =
          diigolet.consts.HTML_HIGHLIGHT_SHARE_WINDOW; var d = {}
      d.enabled = false
      d.init = function () {
        var f = this
        f.create()
        ...
        $("#diigolet-highlight-footer").on("click", "a", function (h) {
          if (f.enable) {
            ...
            if (h === "diigolet-highlight-share-copybtn") {
              ...
              var i = encodeURIComponent(f.ann.prettyTxt); var m = encodeURIComponent(f.url)
    ...
    var sa = {
      ...
      bindMouseOver: function () {
        ...
        $(document).bind("mousemove", function (d) {
          if (d.target.tagName == "IMG") {
            ...
            d = d.target
            var f = $(d).offset().left; var h = $(d).offset().top; var i = $(d).width(); var m = $(d).height()
            if (a.shown == false) {
              if (i >= 200 || m >= 200) {
            ...
            m = d.height()
            if (i >= 200 || m >= 200) {
              h + m > document.body.scrollTop + window.innerHeight ? $("#diigo-image-clipper").css("top", h + 3 + "px").css("left", f + i - 55 + "px").show() : $("#diigo-image-clipper").css("top",
      ...
      saveAndTagOnClick: function () {
        if (da()) {
          if (!k.permissions.premium || k.permissions.image) chrome.extension.sendRequest({ name: "saveImageToDiigo", details: { srcUrl: sa.imageSrc }, Type: "tag" }); else {
            ab.init()
            ab.show("Save images")
          }
        }
      ...
      bindEvents: function () {
        ...
        $(document.body).on("mouseenter", "pre", function () {
          console.log("sdfs")
          var c = $(this).offset().left; var d = $(this).offset().top; var f = $(this).outerWidth(); var h = $(this).outerHeight()
    ...
    var fa = document; var ka = $(window); var Fa = $(fa)
    x.$ = $
