...
define(function (require, exports, module) {
  ...
  function maxdepth (node) {
    var lngChiln = 0; var lstChiln = []
    var lngMax = 0; var lngDepth = 0; var i = 0
  ...
  function getFoldLevel (editor) {
    ...
    var tree = editor.tree(); var folds = editor.folds()
    var lstLevels = []; var i = 0; var lngFolds = folds.length; var lngLine
  ...
  function setFoldLevel (editor, lngLevel) {
    ...
    var lstNodes = editor.tree().evaluateNodePath(strPath)
